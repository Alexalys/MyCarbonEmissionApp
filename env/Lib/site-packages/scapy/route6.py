...
class Route6:
    ...
    def flush(self):
        ...
        self.routes = (
            []
        )  # type: List[Tuple[str, int, str, str, List[str], int]]  # noqa: E501
    ...
    def route(self, dst="", dev=None, verbose=conf.verb):
        ...
        if dev is None and (in6_islladdr(dst) or in6_ismlladdr(dst)):
            ...
            if dev not in self.ipv6_ifaces and self.ipv6_ifaces:
                ...
                default_routes = [
                    route for route in tmp_routes if (route[0], route[1]) == ("::", 0)
                ]
                ...
                warning(
                    "The conf.iface interface (%s) does not support IPv6! "
        ...
        for p, plen, gw, iface, cset, me in self.routes:
            ...
            if in6_isincluded(dst, p, plen):
                ...
                in6_ismlladdr(dst) and in6_islladdr(p) and in6_islladdr(cset[0])
            ):  # noqa: E501
                paths.append((plen, me, (iface, cset, gw)))
