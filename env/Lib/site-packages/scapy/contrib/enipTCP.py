    ...
    fields_desc = [
        ...
        MultipleTypeField(
            [
                ...
                (
                    PacketField(
                        "commandSpecificData", ENIPRegisterSession, ENIPRegisterSession
                    ),
                    lambda pkt: pkt.commandId == 0x65,
                ),
                # Send RR Data
                (
                    PacketField("commandSpecificData", ENIPSendRRData, ENIPSendRRData),
                    lambda pkt: pkt.commandId == 0x6F,
                ),
                # Send Unit Data
                (
                    PacketField(
                        "commandSpecificData", ENIPSendUnitData, ENIPSendUnitData
                    ),
