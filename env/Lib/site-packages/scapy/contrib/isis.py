...
class ISIS_AreaIdField(Field):
    ...
    def getfield(self, pkt, s):
        ...
        return s[numbytes:], self.m2i(
            pkt, struct.unpack("!%is" % numbytes, s[:numbytes])[0]
        )  # noqa: E501
...
def _ISIS_GuessSubTlvClass_1(p, **kargs):
    return _ISIS_GuessTlvClass_Helper(
        _isis_subtlv_classes_1, "ISIS_GenericSubTlv", p, **kargs
    )  # noqa: E501
...
class ISIS_IPv4InterfaceAddressSubTlv(ISIS_GenericSubTlv):
    ...
    fields_desc = [
        ByteEnumField("type", 6, _isis_subtlv_names_1),
...
class ISIS_IPv4NeighborAddressSubTlv(ISIS_GenericSubTlv):
    ...
    fields_desc = [
        ByteEnumField("type", 8, _isis_subtlv_names_1),
        FieldLenField("len", None, length_of="address", fmt="B"),
        IPField("address", "0.0.0.0"),
    ]
...
class ISIS_LinkLocalRemoteIdentifiersSubTlv(ISIS_GenericSubTlv):
    ...
    fields_desc = [
        ByteEnumField("type", 4, _isis_subtlv_names_1),
...
class ISIS_IPv6InterfaceAddressSubTlv(ISIS_GenericSubTlv):
    ...
    fields_desc = [
        ByteEnumField("type", 12, _isis_subtlv_names_1),
        FieldLenField("len", None, length_of="address", fmt="B"),
        IP6Field("address", "::"),
    ]
...
class ISIS_MaximumLinkBandwidthSubTlv(ISIS_GenericSubTlv):
    ...
    fields_desc = [
        ByteEnumField("type", 9, _isis_subtlv_names_1),
...
class ISIS_MaximumReservableLinkBandwidthSubTlv(ISIS_GenericSubTlv):
    ...
    fields_desc = [
        ByteEnumField("type", 10, _isis_subtlv_names_1),
...
class ISIS_UnreservedBandwidthSubTlv(ISIS_GenericSubTlv):
    ...
    fields_desc = [
        ...
        FieldListField(
            ...
            IEEEFloatField("", 1000),
            count_from=lambda pkt: pkt.len / 4,
        ),
    ]  # in B/s  # noqa: E501
...
class ISIS_TEDefaultMetricSubTlv(ISIS_GenericSubTlv):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "len", None, length_of="temetric", adjust=lambda pkt, x: x - 1, fmt="B"
        ),  # noqa: E501
...
def _ISIS_GuessSubTlvClass_2(p, **kargs):
    return _ISIS_GuessTlvClass_Helper(
        _isis_subtlv_classes_2, "ISIS_GenericSubTlv", p, **kargs
    )  # noqa: E501
...
class ISIS_32bitAdministrativeTagSubTlv(ISIS_GenericSubTlv):
    ...
    fields_desc = [
        ByteEnumField("type", 1, _isis_subtlv_names_2),
        FieldLenField("len", None, length_of="tags", fmt="B"),
        FieldListField(
            "tags", [], IntField("", 0), count_from=lambda pkt: pkt.len // 4
        ),
    ]  # noqa: E501
...
class ISIS_64bitAdministrativeTagSubTlv(ISIS_GenericSubTlv):
    ...
    fields_desc = [
        ...
        FieldLenField("len", None, length_of="tags", fmt="B"),
        FieldListField(
            "tags", [], LongField("", 0), count_from=lambda pkt: pkt.len // 8
        ),
    ]  # noqa: E501
...
class ISIS_SIDLabelSubTLV(ISIS_GenericSubTlv):
    ...
    fields_desc = [
        ...
        ByteField("len", 3),
        ConditionalField(ThreeBytesField("sid", 0), lambda pkt: pkt.len == 3),
        ConditionalField(IntField("idx", 0), lambda pkt: pkt.len == 4),
    ]
...
class ISIS_SRCapabilitiesSubTLV(ISIS_GenericSubTlv):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "len", None, length_of="srgb_ranges", adjust=lambda pkt, x: x + 1, fmt="B"
        ),
        FlagsField(
            "flags", 0, 8, ["res1", "res2", "res3", "res4", "res5", "res6", "V", "I"]
        ),
        PacketListField(
            "srgb_ranges",
            [],
...
class ISIS_SRAlgorithmSubTLV(ISIS_GenericSubTlv):
    ...
    fields_desc = [
        ...
        FieldListField(
            "algorithms", [0], ByteField("", 0), count_from=lambda pkt: pkt.len
        ),
    ]
...
def _ISIS_GuessTlvClass(p, **kargs):
    return _ISIS_GuessTlvClass_Helper(
        _isis_tlv_classes, "ISIS_GenericTlv", p, **kargs
    )  # noqa: E501
...
class ISIS_AreaEntry(Packet):
    ...
    fields_desc = [
        FieldLenField("arealen", None, length_of="areaid", fmt="B"),
...
class ISIS_AreaTlv(ISIS_GenericTlv):
    name = "ISIS Area TLV"
    fields_desc = [
        ByteEnumField("type", 1, _isis_tlv_names),
...
class ISIS_AuthenticationTlv(ISIS_GenericTlv):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "len", None, length_of="password", adjust=lambda pkt, x: x + 1, fmt="B"
        ),  # noqa: E501
        ByteEnumField("authtype", 1, {1: "Plain", 17: "HMAC-MD5"}),
        BoundStrLenField(
            "password", "", maxlen=254, length_from=lambda pkt: pkt.len - 1
        ),
    ]  # noqa: E501
...
class ISIS_BufferSizeTlv(ISIS_GenericTlv):
    ...
    fields_desc = [
        ByteEnumField("type", 14, _isis_tlv_names),
        ByteField("len", 2),
...
class ISIS_ChecksumTlv(ISIS_GenericTlv):
    ...
    fields_desc = [
        ByteEnumField("type", 12, _isis_tlv_names),
        ByteField("len", 2),
...
class ISIS_DynamicHostnameTlv(ISIS_GenericTlv):
    ...
    fields_desc = [
        ByteEnumField("type", 137, _isis_tlv_names),
...
class ISIS_ExtendedIpPrefix(Packet):
    ...
    fields_desc = [
        ...
        IPPrefixField(
            "pfx", None, wordbytes=1, length_from=lambda x: x.pfxlen
        ),  # noqa: E501
        ConditionalField(
...
class ISIS_TERouterIDTlv(ISIS_GenericTlv):
    ...
    fields_desc = [
        ByteEnumField("type", 134, _isis_tlv_names),
...
class ISIS_ExtendedIpReachabilityTlv(ISIS_GenericTlv):
    ...
    fields_desc = [
        ByteEnumField("type", 135, _isis_tlv_names),
        FieldLenField("len", None, length_of="pfxs", fmt="B"),
        PacketListField(
            "pfxs", [], ISIS_ExtendedIpPrefix, length_from=lambda pkt: pkt.len
        ),
    ]  # noqa: E501
...
class ISIS_ExtendedIsNeighbourEntry(Packet):
    ...
    fields_desc = [
        ...
        FieldLenField("subtlvslen", None, length_of="subtlvs", fmt="B"),
        PacketListField(
            "subtlvs", [], _ISIS_GuessSubTlvClass_1, length_from=lambda x: x.subtlvslen
        ),  # noqa: E501
    ]
...
class ISIS_ExtendedIsReachabilityTlv(ISIS_GenericTlv):
    ...
    fields_desc = [
        ByteEnumField("type", 22, _isis_tlv_names),
        FieldLenField("len", None, length_of="neighbours", fmt="B"),
        PacketListField(
            "neighbours", [], ISIS_ExtendedIsNeighbourEntry, length_from=lambda x: x.len
        ),
    ]  # noqa: E501
...
class ISIS_IpInterfaceAddressTlv(ISIS_GenericTlv):
    ...
    fields_desc = [
        ByteEnumField("type", 132, _isis_tlv_names),
        FieldLenField("len", None, length_of="addresses", fmt="B"),
        FieldListField(
            "addresses", [], IPField("", "0.0.0.0"), count_from=lambda pkt: pkt.len // 4
        ),
    ]  # noqa: E501
...
class ISIS_Ipv6ReachabilityTlv(ISIS_GenericTlv):
    ...
    fields_desc = [
        ByteEnumField("type", 236, _isis_tlv_names),
        FieldLenField("len", None, length_of="pfxs", fmt="B"),
...
class ISIS_IsNeighbourTlv(ISIS_GenericTlv):
    ...
    fields_desc = [
        ByteEnumField("type", 6, _isis_tlv_names),
        FieldLenField("len", None, length_of="neighbours", fmt="B"),
        FieldListField(
            "neighbours",
            [],
...
class ISIS_LspEntryTlv(ISIS_GenericTlv):
    ...
    fields_desc = [
        ...
        PacketListField(
            "entries", [], ISIS_LspEntry, count_from=lambda pkt: pkt.len // 16
        ),  # noqa: E501
    ]
...
class ISIS_P2PAdjacencyStateTlv(ISIS_GenericTlv):
    ...
    fields_desc = [
        ...
        ByteEnumField(
            "state", "Down", {0x2: "Down", 0x1: "Initialising", 0x0: "Up"}
        ),  # noqa: E501
        ConditionalField(
            IntField("extlocalcircuitid", None), lambda pkt: pkt.len >= 5
        ),  # noqa: E501
        ConditionalField(
            ISIS_SystemIdField("neighboursystemid", None), lambda pkt: pkt.len >= 11
        ),  # noqa: E501
        ConditionalField(
            IntField("neighbourextlocalcircuitid", None), lambda pkt: pkt.len == 15
        ),
    ]  # noqa: E501
...
class ISIS_ProtocolsSupportedTlv(ISIS_GenericTlv):
    ...
    fields_desc = [
        ...
        FieldListField(
            "nlpids",
            [],
            ByteEnumField("", "IPv4", network_layer_protocol_ids),
...
class ISIS_RouterCapabilityTlv(ISIS_GenericTlv):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "len", None, length_of="subtlvs", adjust=lambda pkt, x: x + 5, fmt="B"
        ),
        IPField("routerid", "0.0.0.0"),
        FlagsField(
            "flags", 0, 8, ["S", "D", "res1", "res2", "res3", "res4", "res5", "res6"]
        ),
        PacketListField(
            "subtlvs", [], _ISIS_GuessSubTlvClass_4, length_from=lambda pkt: pkt.len - 5
        ),
    ]
...
class ISIS_InternalIpReachabilityTlv(ISIS_GenericTlv):
    ...
    fields_desc = [
        ...
        FieldLenField("len", None, length_of="entries", fmt="B"),
        PacketListField(
            "entries", [], ISIS_IpReachabilityEntry, count_from=lambda x: x.len // 12
        ),  # noqa: E501
    ]
...
class ISIS_IsReachabilityTlv(ISIS_GenericTlv):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "len", None, fmt="B", length_of="neighbours", adjust=lambda pkt, x: x + 1
        ),  # noqa: E501
        ByteField("virtual", 0),
        PacketListField(
            "neighbours",
            [],
            ISIS_IsReachabilityEntry,
