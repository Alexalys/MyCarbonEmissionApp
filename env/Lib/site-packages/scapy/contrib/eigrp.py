...
class EIGRPGeneric(Packet):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "len", None, "value", "!H", adjust=lambda pkt, x: x + 4
        ),  # noqa: E501
...
class EIGRPAuthData(EIGRPGeneric):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "len", None, "authdata", "!H", adjust=lambda pkt, x: x + 24
        ),  # noqa: E501
        ...
        StrLenField(
            "authdata", RandString(16), length_from=lambda pkt: pkt.keysize
        ),  # noqa: E501
    ]
    ...
    def post_build(self, p, pay):
        ...
        if self.keysize is None:
            ...
            p = (
                p[:6] + chb((keysize >> 8) & 0xFF) + chb(keysize & 0xFF) + p[8:]
            )  # noqa: E501
...
class EIGRPSeq(EIGRPGeneric):
    ...
    fields_desc = [
        ...
        ByteField("addrlen", 4),
        ConditionalField(
            IPField("ipaddr", "192.168.0.1"), lambda pkt: pkt.addrlen == 4
        ),
...
class EIGRPIntRoute(EIGRPGeneric):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "len", None, "dst", "!H", adjust=lambda pkt, x: x + 25
        ),  # noqa: E501
        ...
        EigrpIPField(
            "dst", "192.168.1.0", length_from=lambda pkt: pkt.prefixlen
        ),  # noqa: E501
    ]
...
class EIGRPExtRoute(EIGRPGeneric):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "len", None, "dst", "!H", adjust=lambda pkt, x: x + 45
        ),  # noqa: E501
        IPField("nexthop", "192.168.0.0"),
...
class EIGRPv6IntRoute(EIGRPGeneric):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "len", None, "dst", "!H", adjust=lambda pkt, x: x + 37
        ),  # noqa: E501
        IP6Field("nexthop", "::"),
        IntField("delay", 128000),
        ...
        EigrpIP6Field(
            "dst", "2001::", length_from=lambda pkt: pkt.prefixlen
        ),  # noqa: E501
    ]
...
class EIGRPv6ExtRoute(EIGRPGeneric):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "len", None, "dst", "!H", adjust=lambda pkt, x: x + 57
        ),  # noqa: E501
        IP6Field("nexthop", "::"),
        IPField("originrouter", "192.168.0.1"),
        IntField("originasn", 0),
