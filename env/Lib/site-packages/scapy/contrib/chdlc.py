...
class CHDLC(Packet):
    ...
    fields_desc = [
        ByteEnumField(
            "address", 0x0F, {0x0F: "unicast", 0x8F: "multicast"}
        ),  # noqa: E501
        ByteField("control", 0),
...
class SLARP(Packet):
    ...
    fields_desc = [
        IntEnumField(
            "type", 2, {0: "request", 1: "reply", 2: "line keepalive"}
        ),  # noqa: E501
        ConditionalField(
        ...
        ConditionalField(
            IPField("mask", "255.255.255.0"), lambda pkt: pkt.type == 0 or pkt.type == 1
        ),  # noqa: E501
        ConditionalField(
            XShortField("unused", 0), lambda pkt: pkt.type == 0 or pkt.type == 1
        ),  # noqa: E501
