...
class LTP(Packet):
    ...
    fields_desc = [
        ...
        BitFieldLenField(
            "HeaderExtensionCount", None, 4, count_of="HeaderExtensions"
        ),  # noqa: E501
        BitFieldLenField(
            "TrailerExtensionCount", None, 4, count_of="TrailerExtensions"
        ),  # noqa: E501
        PacketListField(
            "HeaderExtensions", [], LTPex, count_from=lambda x: x.HeaderExtensionCount
        ),  # noqa: E501
        #
        # LTP segments containing data have a DATA header
        #
        ConditionalField(
            SDNV2("DATA_ClientServiceID", 0), lambda x: x.flags in _ltp_data_segment
        ),
        ConditionalField(
            SDNV2("DATA_PayloadOffset", 0), lambda x: x.flags in _ltp_data_segment
        ),
        ConditionalField(
            SDNV2FieldLenField(
                "DATA_PayloadLength", None, length_of="LTP_Payload"
            ),  # noqa: E501
        ...
        #
        ConditionalField(
            SDNV2("CheckpointSerialNo", 0), lambda x: x.flags in _ltp_checkpoint_segment
        ),
        #
        ...
        ConditionalField(
            ...
            lambda x: x.flags in _ltp_checkpoint_segment or x.flags == 8,
        ),
        #
        ...
        ConditionalField(
            SDNV2FieldLenField(
                "ReportReceptionClaimCount", None, count_of="ReportReceptionClaims"
            ),  # noqa: E501
            lambda x: x.flags == 8,
        ),
        ConditionalField(
            ...
            lambda x: x.flags == 8
            and (not x.ReportReceptionClaimCount or x.ReportReceptionClaimCount > 0),
        ),  # noqa: E501
        #
        ...
        #
        PacketListField(
            "TrailerExtensions", [], LTPex, count_from=lambda x: x.TrailerExtensionCount
        ),  # noqa: E501
    ]
