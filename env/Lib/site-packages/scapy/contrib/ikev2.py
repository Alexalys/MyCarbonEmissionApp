...
class IKEv2_class(Packet):
    def guess_payload_class(self, payload):
        ...
        if np == 0:
            ...
            logging.debug(
                globals().get("IKEv2_payload_%s" % pt, IKEv2_payload)
            )  # noqa: E501
...
class IKEv2(IKEv2_class):  # rfc4306
    ...
    fields_desc = [
        ...
        IntField(
            "length", None
        ),  # Length of total message: packets + all payloads  # noqa: E501
    ]
...
class IKEv2_Key_Length_Attribute(IntField):
    ...
    def h2i(self, pkt, x):
        return IntField.h2i(
            self, pkt, (x if x is not None else 0) | 0x800E0000
        )  # noqa: E501
...
class IKEv2_payload_Transform(IKEv2_class):
    ...
    fields_desc = [
        ...
        MultiEnumField(
            ...
            None,
            IKEv2TransformNum,
            depends_on=lambda pkt: pkt.transform_type,
            fmt="H",
        ),  # noqa: E501
        ConditionalField(
            IKEv2_Key_Length_Attribute("key_length"), lambda pkt: pkt.length > 8
        ),  # noqa: E501
    ]
...
class IKEv2_payload_Proposal(IKEv2_class):
    ...
    fields_desc = [
        ...
        FieldLenField(
            ...
            "trans",
            "H",
            adjust=lambda pkt, x: x + 8 + (pkt.SPIsize if pkt.SPIsize else 0),
        ),  # noqa: E501
...
class IKEv2_payload_VendorID(IKEv2_class):
    ...
    fields_desc = [
        ...
        ByteField("res", 0),
        FieldLenField(
            "length", None, "vendorID", "H", adjust=lambda pkt, x: x + 4
        ),  # noqa: E501
...
class IKEv2_payload_TSi(IKEv2_class):
    ...
    fields_desc = [
        ...
        ByteField("res", 0),
        FieldLenField(
            "length", None, "traffic_selector", "H", adjust=lambda pkt, x: x + 8
        ),  # noqa: E501
...
class IKEv2_payload_Notify(IKEv2_class):
    ...
    fields_desc = [
        ...
        FieldLenField("length", None, "load", "H", adjust=lambda pkt, x: x + 8),
        ByteEnumField(
            "proto", None, {0: "Reserved", 1: "IKE", 2: "AH", 3: "ESP"}
        ),  # noqa: E501
        FieldLenField("SPIsize", None, "SPI", "B"),
...
class IKEv2_payload_Encrypted_Fragment(IKEv2_class):
    ...
    fields_desc = [
        ...
        ByteField("res", 0),
        FieldLenField(
            "length", None, "load", "H", adjust=lambda pkt, x: x + 8
        ),  # noqa: E501
...
class IKEv2_payload_CERTREQ(IKEv2_class):
    ...
    fields_desc = [
        ...
        ByteField("res", 0),
        FieldLenField(
            "length", None, "cert_data", "H", adjust=lambda pkt, x: x + 5
        ),  # noqa: E501
...
class IKEv2_payload_CERT_CRT(IKEv2_payload_CERT):
    ...
    fields_desc = [
        ...
        FieldLenField(
            ...
            "x509Cert",
            "H",
            adjust=lambda pkt, x: x + len(pkt.x509Cert) + 5,
        ),  # noqa: E501
        ByteEnumField("cert_type", 4, IKEv2CertificateEncodings),
        PacketLenField(
            "x509Cert", X509_Cert(""), X509_Cert, length_from=lambda x: x.length - 5
        ),  # noqa: E501
    ]
...
class IKEv2_payload_CERT_CRL(IKEv2_payload_CERT):
    ...
    fields_desc = [
        ...
        FieldLenField(
            ...
            "x509CRL",
            "H",
            adjust=lambda pkt, x: x + len(pkt.x509CRL) + 5,
        ),  # noqa: E501
        ByteEnumField("cert_type", 7, IKEv2CertificateEncodings),
        PacketLenField(
            "x509CRL", X509_CRL(""), X509_CRL, length_from=lambda x: x.length - 5
        ),  # noqa: E501
    ]
