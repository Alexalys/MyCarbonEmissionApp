...
class OFPHETVersionBitmap(_ofp_header):
    ...
    fields_desc = [
        ...
        FlagsField(
            ...
            0,
            32,
            ["Type 0", "OFv1.0", "OFv1.1", "OFv1.2", "OFv1.3", "OFv1.4", "OFv1.5"],
        ),
    ]
...
def add_ofp_oxm_fields(i, org):
    ofp_oxm_fields[i] = [
        ShortEnumField("class", "OFPXMC_OPENFLOW_BASIC", ofp_oxm_classes),  # noqa: E501
...
def _create_oxm_cls():
    ...
    cls = type(
        cls_name, (Packet,), {"name": oxm_name, "fields_desc": oxm_fields}
    )  # noqa: E501
...
class OXMPacketListField(PacketListField):
    ...
    def __init__(
        self, name, default, cls, length_from=None, autocomplete=False
    ):  # noqa: E501
    ...
    def i2m(self, pkt, val):
        ...
        if (
            self.autocomplete or conf.contribs["OPENFLOW"]["prereq_autocomplete"]
        ):  # noqa: E501
...
class OFPMatch(Packet):
    name = "OFP_MATCH"
    fields_desc = [
        ShortEnumField("type", 1, {0: "OFPMT_STANDARD", 1: "OFPMT_OXM"}),
        ShortField("len", None),
        OXMPacketListField(
            "oxm_fields", [], Packet, length_from=lambda pkt: pkt.len - 4
        ),
    ]
...
class OFPATOutput(OFPAT):
    name = "OFPAT_OUTPUT"
    fields_desc = [
        ShortEnumField("type", 0, ofp_action_types),
        ShortField("len", 16),
...
class OFPATSetVLANVID(OFPAT):
    ...
    fields_desc = [
        ShortEnumField("type", 1, ofp_action_types),
        ShortField("len", 8),
...
class OFPATSetVLANPCP(OFPAT):
    ...
    fields_desc = [
        ShortEnumField("type", 2, ofp_action_types),
        ShortField("len", 8),
...
class OFPATStripVLAN(OFPAT):
    ...
    fields_desc = [
        ShortEnumField("type", 3, ofp_action_types),
        ShortField("len", 8),
        XIntField("pad", 0),
    ]
...
class OFPATSetNwSrc(OFPAT):
    ...
    fields_desc = [
        ShortEnumField("type", 6, ofp_action_types),
        ShortField("len", 8),
        IPField("nw_addr", "0"),
    ]
...
class OFPATSetNwDst(OFPAT):
    ...
    fields_desc = [
        ShortEnumField("type", 7, ofp_action_types),
        ShortField("len", 8),
        IPField("nw_addr", "0"),
    ]
...
class OFPATSetNwToS(OFPAT):
    ...
    fields_desc = [
        ShortEnumField("type", 8, ofp_action_types),
        ShortField("len", 8),
        ByteField("nw_tos", 0),
        X3BytesField("pad", 0),
    ]
...
class OFPATSetTpSrc(OFPAT):
    ...
    fields_desc = [
        ShortEnumField("type", 9, ofp_action_types),
        ShortField("len", 8),
...
class OFPATSetTpDst(OFPAT):
    ...
    fields_desc = [
        ShortEnumField("type", 10, ofp_action_types),
        ShortField("len", 8),
        ShortField("tp_port", 0),
        XShortField("pad", 0),
    ]
...
class OFPATSetMPLSLabel(OFPAT):
    ...
    fields_desc = [
        ShortEnumField("type", 13, ofp_action_types),
        ShortField("len", 8),
...
class OFPATSetMPLSTC(OFPAT):
    ...
    fields_desc = [
        ShortEnumField("type", 14, ofp_action_types),
        ShortField("len", 8),
        ByteField("mpls_tc", 0),
        X3BytesField("pad", 0),
    ]
...
class OFPATCopyTTLOut(OFPAT):
    ...
    fields_desc = [
        ShortEnumField("type", 11, ofp_action_types),
        ShortField("len", 8),
        XIntField("pad", 0),
    ]
...
class OFPATCopyTTLIn(OFPAT):
    ...
    fields_desc = [
        ShortEnumField("type", 12, ofp_action_types),
        ShortField("len", 8),
        XIntField("pad", 0),
    ]
...
class OFPATSetMPLSTTL(OFPAT):
    ...
    fields_desc = [
        ShortEnumField("type", 15, ofp_action_types),
        ShortField("len", 8),
...
class OFPATDecMPLSTTL(OFPAT):
    ...
    fields_desc = [
        ShortEnumField("type", 16, ofp_action_types),
        ShortField("len", 8),
        XIntField("pad", 0),
    ]
...
class OFPATPopVLAN(OFPAT):
    name = "OFPAT_POP_VLAN"
    fields_desc = [
        ShortEnumField("type", 18, ofp_action_types),
        ShortField("len", 8),
        XIntField("pad", 0),
    ]
...
class OFPATSetQueue(OFPAT):
    ...
    fields_desc = [
        ShortEnumField("type", 21, ofp_action_types),
        ShortField("len", 8),
        IntEnumField("queue_id", 0, ofp_queue),
    ]
...
class OFPATGroup(OFPAT):
    name = "OFPAT_GROUP"
    fields_desc = [
        ShortEnumField("type", 22, ofp_action_types),
        ShortField("len", 8),
...
class OFPATSetNwTTL(OFPAT):
    ...
    fields_desc = [
        ShortEnumField("type", 23, ofp_action_types),
        ShortField("len", 8),
        ByteField("nw_ttl", 0),
        X3BytesField("pad", 0),
    ]
...
class OFPATDecNwTTL(OFPAT):
    ...
    fields_desc = [
        ShortEnumField("type", 24, ofp_action_types),
        ShortField("len", 8),
        XIntField("pad", 0),
    ]
...
class OFPATPushPBB(OFPAT):
    name = "OFPAT_PUSH_PBB"
    fields_desc = [
        ShortEnumField("type", 26, ofp_action_types),
        ShortField("len", 8),
...
class OFPATPopPBB(OFPAT):
    name = "OFPAT_POP_PBB"
    fields_desc = [
        ShortEnumField("type", 27, ofp_action_types),
        ShortField("len", 8),
        XIntField("pad", 0),
    ]
...
class OFPITGotoTable(OFPIT):
    ...
    fields_desc = [
        ShortEnumField("type", 1, ofp_instruction_types),
        ShortField("len", 8),
...
class OFPITWriteMetadata(OFPIT):
    ...
    fields_desc = [
        ShortEnumField("type", 2, ofp_instruction_types),
        ShortField("len", 24),
        XIntField("pad", 0),
...
class OFPITWriteActions(OFPIT):
    ...
    fields_desc = [
        ShortEnumField("type", 3, ofp_instruction_types),
        ShortField("len", None),
        XIntField("pad", 0),
        PacketListField("actions", [], OFPAT, length_from=lambda pkt: pkt.len - 8),
    ]
...
class OFPITApplyActions(OFPIT):
    ...
    fields_desc = [
        ShortEnumField("type", 4, ofp_instruction_types),
        ShortField("len", None),
        XIntField("pad", 0),
        PacketListField("actions", [], OFPAT, length_from=lambda pkt: pkt.len - 8),
    ]
...
class OFPITClearActions(OFPIT):
    ...
    fields_desc = [
        ShortEnumField("type", 5, ofp_instruction_types),
        ShortField("len", 8),
        XIntField("pad", 0),
    ]
...
class OFPITMeter(OFPIT):
    name = "OFPIT_METER"
    fields_desc = [
        ShortEnumField("type", 6, ofp_instruction_types),
        ShortField("len", 8),
...
class OFPITExperimenter(OFPIT):
    ...
    fields_desc = [
        ShortEnumField("type", 65535, ofp_instruction_types),
        ShortField("len", None),
        IntField("experimenter", 0),
    ]
...
class OFPQTNone(OFPQT):
    name = "OFPQT_NONE"
    fields_desc = [
        ShortEnumField("type", 0, ofp_queue_property_types),
        ShortField("len", 8),
        XIntField("pad", 0),
    ]
...
class OFPPacketQueue(Packet):
    ...
    fields_desc = [
        ...
        ShortField("len", None),
        XShortField("pad", 0),
        PacketListField("properties", [], OFPQT, length_from=lambda pkt: pkt.len - 8),
    ]  # noqa: E501
...
class OFPMBTExperimenter(OFPMBT):
    ...
    fields_desc = [
        ShortEnumField("type", 65535, ofp_queue_property_types),
        ShortField("len", 16),
        IntField("rate", 0),
        IntField("burst_size", 0),
        IntField("experimenter", 0),
...
class OFPETTableModFailed(_ofp_header):
    ...
    fields_desc = [
        ...
        ShortEnumField(
            "errcode",
            0,
            {0: "OFPTMFC_BAD_TABLE", 1: "OFPTMFC_BAD_CONFIG", 2: "OFPTMFC_EPERM"},
        ),
        OFPacketField("data", "", Raw),
    ]
...
class OFPETQueueOpFailed(_ofp_header):
    ...
    fields_desc = [
        ...
        ShortEnumField(
            "errcode",
            0,
            {0: "OFPQOFC_BAD_PORT", 1: "OFPQOFC_BAD_QUEUE", 2: "OFPQOFC_EPERM"},
        ),
        OFPacketField("data", "", Raw),
    ]
...
class OFPETSwitchConfigFailed(_ofp_header):
    ...
    fields_desc = [
        ...
        ShortEnumField(
            "errcode",
            0,
            {0: "OFPSCFC_BAD_FLAGS", 1: "OFPSCFC_BAD_LEN", 2: "OFPSCFC_EPERM"},
        ),
        OFPacketField("data", "", Raw),
    ]
...
class OFPETRoleRequestFailed(_ofp_header):
    ...
    fields_desc = [
        ...
        ShortEnumField(
            "errcode",
            0,
            {0: "OFPRRFC_STALE", 1: "OFPRRFC_UNSUP", 2: "OFPRRFC_BAD_ROLE"},
        ),
        OFPacketField("data", "", Raw),
    ]
...
class OFPTGetConfigReply(_ofp_header):
    ...
    fields_desc = [
        ...
        ShortEnumField(
            "flags",
            0,
            {0: "FRAG_NORMAL", 1: "FRAG_DROP", 2: "FRAG_REASM", 3: "FRAG_MASK"},
        ),
...
class OFPTPacketIn(_ofp_header):
    ...
    fields_desc = [
        ...
        ByteEnumField(
            "reason", 0, {0: "OFPR_NO_MATCH", 1: "OFPR_ACTION", 2: "OFPR_INVALID_TTL"}
        ),
        ByteEnumField("table_id", 0, ofp_table),
        LongField("cookie", 0),
        MatchField("match"),
...
class OFPTPortStatus(_ofp_header):
    ...
    fields_desc = [
        ...
        IntField("xid", 0),
        ByteEnumField(
            "reason", 0, {0: "OFPPR_ADD", 1: "OFPPR_DELETE", 2: "OFPPR_MODIFY"}
        ),
        XBitField("pad", 0, 56),
...
class OFPTPacketOut(_ofp_header):
    ...
    fields_desc = [
        ...
        XBitField("pad", 0, 48),
        PacketListField(
            "actions", [], OFPAT, OFPAT, length_from=lambda pkt: pkt.actions_len
        ),
        PacketField("data", "", Ether),
    ]
...
class OFPTFlowMod(_ofp_header):
    ...
    fields_desc = [
        ...
        PacketListField(
            ...
            - 48
            - (pkt.match.len + (8 - pkt.match.len % 8) % 8),
        ),
    ]  # noqa: E501
...
class OFPTGroupMod(_ofp_header):
    ...
    fields_desc = [
        ...
        IntField("xid", 0),
        ShortEnumField(
            "cmd", 0, {0: "OFPGC_ADD", 1: "OFPGC_MODIFY", 2: "OFPGC_DELETE"}
        ),
        ByteEnumField(
            "group_type",
            0,
            {0: "OFPGT_ALL", 1: "OFPGT_SELECT", 2: "OFPGT_INDIRECT", 3: "OFPGT_FF"},
        ),
        XByteField("pad", 0),
        IntEnumField("group_id", 0, ofp_group),
...
class OFPFlowStats(_ofp_header_item):
    ...
    fields_desc = [
        ...
        PacketListField(
            ...
            [],
            OFPIT,
            length_from=lambda pkt: pkt.len - 56 - pkt.match.len,
        ),
    ]  # noqa: E501
...
class OFPMPReplyFlow(_ofp_header):
    ...
    fields_desc = [
        ...
        XIntField("pad1", 0),
        PacketListField(
            "flow_stats", [], OFPFlowStats, length_from=lambda pkt: pkt.len - 16
        ),
    ]
...
class OFPMPReplyTable(_ofp_header):
    ...
    fields_desc = [
        ...
        XIntField("pad1", 0),
        PacketListField(
            "table_stats", None, OFPTableStats, length_from=lambda pkt: pkt.len - 16
        ),
    ]
...
class OFPMPReplyPortStats(_ofp_header):
    ...
    fields_desc = [
        ...
        XIntField("pad1", 0),
        PacketListField(
            "port_stats", None, OFPPortStats, length_from=lambda pkt: pkt.len - 16
        ),
    ]
...
class OFPMPReplyQueue(_ofp_header):
    ...
    fields_desc = [
        ...
        XIntField("pad1", 0),
        PacketListField(
            "queue_stats", None, OFPQueueStats, length_from=lambda pkt: pkt.len - 16
        ),
    ]
...
class OFPGroupStats(_ofp_header_item):
    ...
    fields_desc = [
        ...
        IntField("duration_nsec", 0),
        PacketListField(
            "bucket_stats", None, OFPBucketStats, length_from=lambda pkt: pkt.len - 40
        ),
    ]
...
class OFPMPReplyGroup(_ofp_header):
    ...
    fields_desc = [
        ...
        XIntField("pad1", 0),
        PacketListField(
            "group_stats", [], OFPGroupStats, length_from=lambda pkt: pkt.len - 16
        ),
    ]
...
class OFPGroupDesc(_ofp_header_item):
    ...
    fields_desc = [
        ...
        IntEnumField("group_id", 0, ofp_group),
        PacketListField(
            "buckets", None, OFPBucket, length_from=lambda pkt: pkt.len - 8
        ),
    ]
...
class OFPMPReplyGroupDesc(_ofp_header):
    ...
    fields_desc = [
        ...
        XIntField("pad1", 0),
        PacketListField(
            "group_descs", [], OFPGroupDesc, length_from=lambda pkt: pkt.len - 16
        ),
    ]
...
ofp_action_types_flags = [
    v for v in six.itervalues(ofp_action_types) if v != "OFPAT_EXPERIMENTER"
]
...
class OFPMeterStats(Packet):
    ...
    fields_desc = [
        ...
        IntField("duration_nsec", 0),
        PacketListField(
            "band_stats", None, OFPMeterBandStats, length_from=lambda pkt: pkt.len - 40
        ),
    ]
...
class OFPMPReplyMeter(_ofp_header):
    ...
    fields_desc = [
        ...
        XIntField("pad1", 0),
        PacketListField(
            "meter_stats", [], OFPMeterStats, length_from=lambda pkt: pkt.len - 16
        ),
    ]
...
class OFPMeterConfig(_ofp_header_item):
    ...
    fields_desc = [
        ...
        IntEnumField("meter_id", 1, ofp_meter),
        PacketListField("bands", [], OFPMBT, length_from=lambda pkt: pkt.len - 8),
    ]
...
class OFPMPReplyMeterConfig(_ofp_header):
    ...
    fields_desc = [
        ...
        XIntField("pad1", 0),
        PacketListField(
            "meter_configs", [], OFPMeterConfig, length_from=lambda pkt: pkt.len - 16
        ),
    ]
...
class OFPTFPTInstructions(OFPTFPT):
    ...
    fields_desc = [
        ...
        ShortField("len", None),
        PacketListField(
            "instruction_ids", [], OFPITID, length_from=lambda pkt: pkt.len - 4
        ),
    ]
...
class OFPTFPTNextTables(OFPTFPT):
    ...
    fields_desc = [
        ...
        ShortField("len", None),
        PacketListField(
            "next_table_ids", None, OFPTableID, length_from=lambda pkt: pkt.len - 4
        ),
    ]
...
class OFPTFPTWriteActions(OFPTFPT):
    ...
    fields_desc = [
        ShortField("type", 4),
        ShortField("len", None),
        PacketListField("action_ids", [], OFPATID, length_from=lambda pkt: pkt.len - 4),
    ]
...
class OFPTFPTMatch(OFPTFPT):
    ...
    fields_desc = [
        ShortField("type", 8),
        ShortField("len", None),
        PacketListField("oxm_ids", [], OXMID, length_from=lambda pkt: pkt.len - 4),
    ]
...
class OFPTFPTExperimenter(OFPTFPT):
    ...
    fields_desc = [
        ShortField("type", 65534),
        ShortField("len", None),
        IntField("experimenter", 0),
        IntField("exp_type", 0),
        PacketLenField(
            "experimenter_data", None, Raw, length_from=lambda pkt: pkt.len - 12
        ),
    ]
...
class OFPTableFeatures(_ofp_header_item):
    ...
    fields_desc = [
        ...
        PacketListField(
            "properties", [], OFPTFPT, length_from=lambda pkt: pkt.len - 64
        ),
    ]
...
class OFPMPRequestTableFeatures(_ofp_header):
    ...
    fields_desc = [
        ...
        XIntField("pad1", 0),
        PacketListField(
            "table_features", [], OFPTableFeatures, length_from=lambda pkt: pkt.len - 16
        ),
    ]
...
class OFPTQueueGetConfigReply(_ofp_header):
    ...
    fields_desc = [
        ...
        XIntField("pad", 0),
        PacketListField(
            "queues", [], OFPPacketQueue, length_from=lambda pkt: pkt.len - 16
        ),
    ]
...
class OFPTGetAsyncReply(_ofp_header):
    ...
    fields_desc = [
        ...
        FlagsField(
            "flow_removed_mask_master", 0, 32, ofp_flow_removed_reason
        ),  # noqa: E501
...
class OFPTMeterMod(_ofp_header):
    ...
    fields_desc = [
        ...
        IntField("xid", 0),
        ShortEnumField(
            "cmd", 0, {0: "OFPMC_ADD", 1: "OFPMC_MODIFY", 2: "OFPMC_DELETE"}
        ),
        FlagsField("flags", 0, 16, ["KBPS", "PKTPS", "BURST", "STATS"]),
        IntEnumField("meter_id", 1, ofp_meter),
