...
class TacacsAuthenticationStart(Packet):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "rem_addr_len", None, fmt="!B", length_of="rem_addr"
        ),  # noqa: E501
...
class TacacsAuthenticationReply(Packet):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "server_msg_len", None, fmt="!H", length_of="server_msg"
        ),  # noqa: E501
        FieldLenField("data_len", None, fmt="!H", length_of="data"),
        StrLenField(
            "server_msg", "", length_from=lambda x: x.server_msg_len
        ),  # noqa: E501
        StrLenField("data", "", length_from=lambda x: x.data_len),
    ]
...
class TacacsAuthenticationContinue(Packet):
    ...
    fields_desc = [
        FieldLenField(
            "user_msg_len", None, fmt="!H", length_of="user_msg"
        ),  # noqa: E501
        FieldLenField("data_len", None, fmt="!H", length_of="data"),
...
class TacacsAuthorizationRequest(Packet):
    ...
    fields_desc = [
        ...
        FieldListField(
            "arg_len_list", [], ByteField("", 0), length_from=lambda pkt: pkt.arg_cnt
        ),
...
class TacacsClientPacket(Packet):
    ...
    def post_dissect(self, pay):
        ...
        if self.flags == 0:
            pay = obfuscate(
                pay, SECRET, self.session_id, self.version, self.seq
            )  # noqa: E501
            return pay
...
class TacacsHeader(TacacsClientPacket):
    ...
    name = "Tacacs Header"
    fields_desc = [
        ByteEnumField("version", 192, TACACSVERSION),
    ...
    def answers(self, other):
        return (
            isinstance(other, TacacsHeader)
            and self.seq == other.seq + 1
