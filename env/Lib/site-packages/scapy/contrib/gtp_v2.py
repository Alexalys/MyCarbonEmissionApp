...
class IE_MEI(gtp.IE_Base):
    ...
    fields_desc = [
        ...
        BitField("CR_flag", 0, 4),
        BitField("instance", 0, 4),
        gtp.TBCDByteField("MEI", "175675478970685", length_from=lambda x: x.length),
    ]
...
class IE_EPSBearerID(gtp.IE_Base):
    ...
    fields_desc = [
        ByteEnumField("ietype", 73, IEType),
        ShortField("length", None),
        BitField("CR_flag", 0, 4),
        BitField("instance", 0, 4),
        ByteField("EBI", 0),
...
class IE_RAT(gtp.IE_Base):
    name = "IE RAT"
    fields_desc = [
        ByteEnumField("ietype", 82, IEType),
        ShortField("length", None),
        BitField("CR_flag", 0, 4),
        BitField("instance", 0, 4),
...
class IE_ULI(gtp.IE_Base):
    ...
    fields_desc = [
        ...
        ConditionalField(
            PacketField("CGI", 0, ULI_CGI), lambda pkt: bool(pkt.CGI_Present)
        ),
        ConditionalField(
        ...
        ConditionalField(
            PacketField("ECGI", 0, ULI_ECGI), lambda pkt: bool(pkt.ECGI_Present)
        ),
        ConditionalField(
            PacketField("LAI", 0, ULI_LAI), lambda pkt: bool(pkt.LAI_Present)
        ),
    ]
...
class IE_FTEID(gtp.IE_Base):
    ...
    fields_desc = [
        ...
        ConditionalField(
            XBitField("ipv6", "2001::", 128), lambda pkt: pkt.ipv6_present
        ),
    ]
...
class IE_BearerContext(gtp.IE_Base):
    ...
    fields_desc = [
        ByteEnumField("ietype", 93, IEType),
        ShortField("length", None),
        BitField("CR_flag", 0, 4),
        BitField("instance", 0, 4),
        PacketListField(
...
class IE_MMContext_EPS(gtp.IE_Base):
    ...
    fields_desc = [
        ...
        ConditionalField(
            StrLenField("fields", "", length_from=lambda x: x.length - 41),
...
class IE_PDNConnection(gtp.IE_Base):
    ...
    fields_desc = [
        ByteEnumField("ietype", 109, IEType),
        ShortField("length", None),
        BitField("CR_flag", 0, 4),
        BitField("instance", 0, 4),
        PacketListField(
...
class IE_FQDN(gtp.IE_Base):
    name = "IE FQDN"
    fields_desc = [
        ByteEnumField("ietype", 136, IEType),
        ShortField("length", None),
        BitField("CR_flag", 0, 4),
        BitField("instance", 0, 4),
...
class IE_IMSI(gtp.IE_Base):
    ...
    fields_desc = [
        ...
        BitField("CR_flag", 0, 4),
        BitField("instance", 0, 4),
        gtp.TBCDByteField("IMSI", "33607080910", length_from=lambda x: x.length),
    ]
...
class IE_BearerTFT(gtp.IE_Base):
    name = "IE Bearer TFT"
    fields_desc = [
        ByteEnumField("ietype", 84, IEType),
        ShortField("length", None),
        BitField("CR_flag", 0, 4),
        BitField("instance", 0, 4),
        StrLenField("Bearer_TFT", "", length_from=lambda x: x.length),
    ]
...
class IE_AMBR(gtp.IE_Base):
    name = "IE AMBR"
    fields_desc = [
        ByteEnumField("ietype", 72, IEType),
        ShortField("length", None),
        BitField("CR_flag", 0, 4),
        BitField("instance", 0, 4),
...
class IE_MSISDN(gtp.IE_Base):
    ...
    fields_desc = [
        ...
        BitField("CR_flag", 0, 4),
        BitField("instance", 0, 4),
        gtp.TBCDByteField("digits", "33123456789", length_from=lambda x: x.length),
    ]
...
class IE_Indication(gtp.IE_Base):
    ...
    fields_desc = [
        ...
        ConditionalField(BitField("5GSNN26", 0, 1), lambda pkt: pkt.length > 6),
        ConditionalField(BitField("REPREFI", 0, 1), lambda pkt: pkt.length > 6),
        ConditionalField(BitField("5GSIWKI", 0, 1), lambda pkt: pkt.length > 6),
        ...
        ConditionalField(BitField("5GCNRS", 0, 1), lambda pkt: pkt.length > 7),
        ConditionalField(BitField("5GCNRI", 0, 1), lambda pkt: pkt.length > 7),
        ConditionalField(BitField("5SRHOI", 0, 1), lambda pkt: pkt.length > 7),
...
class PCO_IPv4(PCO_Option):
    name = "IPv4"
    fields_desc = [
        ByteEnumField("type", None, PCO_OPTION_TYPES),
...
class PCO_P_CSCF_IPv6_Address_Request(PCO_Protocol):
    ...
    fields_desc = [
        ...
        ByteField("length", None),
        ConditionalField(
            XBitField("address", "2001:db8:0:42::", 128), lambda pkt: pkt.length
        ),
    ]
...
class PCO_IM_CN_Subsystem_Signaling_Flag(PCO_Protocol):
    ...
    fields_desc = [
        ...
        ByteField("length", None),
        PacketListField(
            "Options", None, PCO_option_dispatcher, length_from=len_options
        ),
    ]
...
class PCO_QoS_Rules_With_Support_Indicator(PCO_Protocol):
    ...
    fields_desc = [
        ...
        ByteField("length", None),
        PacketListField(
            "Options", None, PCO_option_dispatcher, length_from=lambda pkt: pkt.length
        ),
    ]
...
class PCO_PPP_Auth(PCO_Protocol):
    ...
    fields_desc = [
        ...
        ConditionalField(
            StrFixedLenField("PeerID", "", length_from=lambda pkt: pkt.PeerID_length),
            lambda pkt: pkt.PeerID_length,
        ),
        ByteField("Password_length", 0),
        ConditionalField(
            StrFixedLenField(
                "Password", "", length_from=lambda pkt: pkt.Password_length
            ),
...
class PCO_PPP_Challenge(PCO_Protocol):
    ...
    fields_desc = [
        ...
        ConditionalField(
            StrFixedLenField("value", "", length_from=lambda pkt: pkt.value_size),
            lambda pkt: pkt.value_size,
        ),
        ConditionalField(
            StrFixedLenField(
                "name", "", length_from=lambda pkt: pkt.length - pkt.value_size - 5
            ),  # noqa: E501
...
class IE_ChargingID(gtp.IE_Base):
    name = "IE Charging ID"
    fields_desc = [
        ByteEnumField("ietype", 94, IEType),
        ShortField("length", None),
        BitField("CR_flag", 0, 4),
        BitField("instance", 0, 4),
...
class IE_ChargingCharacteristics(gtp.IE_Base):
    ...
    fields_desc = [
        ByteEnumField("ietype", 95, IEType),
        ShortField("length", None),
        BitField("CR_flag", 0, 4),
        BitField("instance", 0, 4),
...
class IE_PDN_type(gtp.IE_Base):
    name = "IE PDN Type"
    fields_desc = [
        ByteEnumField("ietype", 99, IEType),
        ShortField("length", None),
        BitField("CR_flag", 0, 4),
        BitField("instance", 0, 4),
        BitField("SPARE", 0, 5),
...
class IE_UE_Timezone(gtp.IE_Base):
    ...
    fields_desc = [
        ByteEnumField("ietype", 114, IEType),
        ShortField("length", None),
        BitField("CR_flag", 0, 4),
        BitField("instance", 0, 4),
...
class IE_Port_Number(gtp.IE_Base):
    name = "IE Port Number"
    fields_desc = [
        ByteEnumField("ietype", 126, IEType),
        ShortField("length", None),
        BitField("CR_flag", 0, 4),
        BitField("instance", 0, 4),
...
class IE_MMBR(gtp.IE_Base):
    ...
    fields_desc = [
        ByteEnumField("ietype", 161, IEType),
        ShortField("length", None),
        BitField("CR_flag", 0, 4),
        BitField("instance", 0, 4),
...
class IE_UPF_SelInd_Flags(gtp.IE_Base):
    ...
    fields_desc = [
        ByteEnumField("ietype", 202, IEType),
        ShortField("length", None),
        BitField("CR_flag", 0, 4),
        BitField("instance", 0, 4),
        BitField("SPARE", 0, 7),
...
class IE_FQCSID(gtp.IE_Base):
    ...
    fields_desc = [
        ...
        ConditionalField(
            BitField("nodeid_nonip", 0, 32), lambda pkt: pkt.nodeid_type == 2
        ),
        ShortField("csid", 0),
    ]
...
class IE_Ran_Nas_Cause(gtp.IE_Base):
    ...
    fields_desc = [
        ByteEnumField("ietype", 172, IEType),
        ShortField("length", None),
        BitField("CR_flag", 0, 4),
        BitField("instance", 0, 4),
