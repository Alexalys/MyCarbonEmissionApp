...
class Auth_Unix(Packet):
    ...
    fields_desc = [
        ...
        FieldListField(
            "auxgids", [], IntField("", None), count_from=lambda pkt: pkt.num_auxgids
        ),
    ]
...
class RPC_Call(Packet):
    ...
    fields_desc = [
        ...
        ConditionalField(
            PacketField("a_unix", Auth_Unix(), Auth_Unix), lambda pkt: pkt.aflavor == 1
        ),
        ConditionalField(
        ...
        ConditionalField(
            PacketField("v_unix", Auth_Unix(), Auth_Unix), lambda pkt: pkt.vflavor == 1
        ),
        ConditionalField(
            PacketField("v_rpcsec_gss", Verifier_RPCSEC_GSS(), Verifier_RPCSEC_GSS),
...
class RPC_Reply(Packet):
    ...
    fields_desc = [
        ...
        ConditionalField(
            PacketField("a_unix", Auth_Unix(), Auth_Unix), lambda pkt: pkt.flavor == 1
        ),
        IntField("length", 0),
