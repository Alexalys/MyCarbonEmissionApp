...
class DtpGenericTlv(Packet):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "length", None, length_of=lambda pkt: pkt.value + 4
        ),  # noqa: E501
...
class DTPDomain(DtpGenericTlv):
    ...
    fields_desc = [
        ShortField("type", 1),
        FieldLenField(
            "length", None, "domain", adjust=lambda pkt, x: x + 4
        ),  # noqa: E501
        StrLenField(
            "domain", b"\x00", length_from=lambda pkt: pkt.length - 4
        ),  # noqa: E501
    ]
...
class DTPStatus(DtpGenericTlv):
    ...
    fields_desc = [
        ShortField("type", 2),
        FieldLenField(
            "length", None, "status", adjust=lambda pkt, x: x + 4
        ),  # noqa: E501
        StrLenField(
            "status", b"\x03", length_from=lambda pkt: pkt.length - 4
        ),  # noqa: E501
    ]
...
class DTPType(DtpGenericTlv):
    ...
    fields_desc = [
        ShortField("type", 3),
        FieldLenField(
            "length", None, "dtptype", adjust=lambda pkt, x: x + 4
        ),  # noqa: E501
        StrLenField(
            "dtptype", b"\xa5", length_from=lambda pkt: pkt.length - 4
        ),  # noqa: E501
    ]
...
def negotiate_trunk(iface=conf.iface, mymac=str(RandMAC())):
    ...
    p /= SNAP()
    p /= DTP(
        tlvlist=[DTPDomain(), DTPStatus(), DTPType(), DTPNeighbor(neighbor=mymac)]
    )  # noqa: E501
    sendp(p)
