...
def ICMPExtension_post_dissection(self, pkt):
    ...
    if IP in pkt:
        ...
        if (
            scapy.layers.inet6.ICMPv6TimeExceeded in pkt
...
scapy.layers.inet6.ICMPv6DestUnreach.post_dissection = (
    ICMPExtension_post_dissection  # noqa: E501
)
scapy.layers.inet6.ICMPv6TimeExceeded.post_dissection = (
    ICMPExtension_post_dissection  # noqa: E501
)
