...
class OFPMatch(Packet):
    ...
    def post_build(self, p, pay):
        ...
        ins = b"".join(
            chb(int("".join(x), 2)) for x in zip(*[iter(lst_bits)] * 8)
        )  # noqa: E501
        p = ins + p[4:]
        return p + pay
...
class OFPTFlowRemoved(_ofp_header):
    ...
    fields_desc = [
        ...
        ByteEnumField(
            "reason",
            0,
            {0: "OFPRR_IDLE_TIMEOUT", 1: "OFPRR_HARD_TIMEOUT", 2: "OFPRR_DELETE"},
        ),
        XByteField("pad1", 0),
...
class OFPTFlowMod(_ofp_header):
    ...
    fields_desc = [
        ...
        PacketListField(
            "actions", [], OFPAT, ofp_action_cls, length_from=lambda pkt: pkt.len - 72
        ),
    ]
...
class OFPTStatsReplyFlow(_ofp_header):
    ...
    fields_desc = [
        ...
        FlagsField("flags", 0, 16, []),
        PacketListField(
            "flow_stats", [], OFPFlowStats, length_from=lambda pkt: pkt.len - 12
        ),
    ]  # noqa: E501
...
class OFPTStatsReplyTable(_ofp_header):
    ...
    fields_desc = [
        ...
        FlagsField("flags", 0, 16, []),
        PacketListField(
            "table_stats", [], OFPTableStats, length_from=lambda pkt: pkt.len - 12
        ),
    ]
...
class OFPTStatsReplyPort(_ofp_header):
    ...
    fields_desc = [
        ...
        FlagsField("flags", 0, 16, []),
        PacketListField(
            "port_stats", [], OFPPortStats, length_from=lambda pkt: pkt.len - 12
        ),
    ]
...
ofp_stats_request_cls = {
    0: OFPTStatsRequestDesc,
