...
class ModbusPDU11ReportSlaveIdResponse(Packet):
    ...
    fields_desc = [
        ...
        ConditionalField(
            StrLenField("slaveId", "", length_from=lambda pkt: pkt.byteCount),
...
class ModbusReadFileSubResponse(Packet):
    ...
    fields_desc = [
        BitFieldLenField(
            "respLength", None, 8, count_of="recData", adjust=lambda pkt, p: p * 2 + 1
        ),
        ByteField("refType", 0x06),
        FieldListField(
            "recData",
...
class ModbusPDU18ReadFIFOQueueResponse(Packet):
    ...
    fields_desc = [
        ...
        FieldListField(
            "FIFOVal", [], ShortField("", 0x0000), count_from=lambda pkt: pkt.byteCount
        ),
    ]
...
class ModbusObjectId(Packet):
    name = "Object"
    fields_desc = [
        ByteEnumField("id", 0x00, _read_device_id_object_id),
