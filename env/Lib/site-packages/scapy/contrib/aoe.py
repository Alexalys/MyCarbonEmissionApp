...
class MacMaskList(Packet):
    ...
    fields_desc = [
        ...
        PacketListField(
            "directives", None, Directive, count_from=lambda pkt: pkt.dir_count
        ),
    ]
...
class AOE(Packet):
    ...
    fields_desc = [
        ...
        ConditionalField(
            PacketField(
                "q_conf_info", QueryConfigInformation(), QueryConfigInformation
            ),
            lambda x: x.cmd == 1,
        ),
        ConditionalField(
            PacketField("mac_m_list", MacMaskList(), MacMaskList), lambda x: x.cmd == 2
        ),
        ConditionalField(
