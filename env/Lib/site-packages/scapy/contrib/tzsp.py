...
class TZSP(Packet):
    ...
    fields_desc = [
        ...
        ShortEnumField(
            "encapsulated_protocol", ENCAPSULATED_ETHERNET, ENCAPSULATED_PROTOCOLS
        ),  # noqa: E501
    ]
    ...
    def get_encapsulated_payload_class(self):
        ...
        try:
            return TZSP.ENCAPSULATED_PROTOCOL_CLASSES[
                self.encapsulated_protocol
            ]  # noqa: E501
        except KeyError:
            warning(
                "unknown or invalid encapsulation type (%i) - returning payload as raw()"
                % self.encapsulated_protocol
            )  # noqa: E501
            return Raw
    ...
    def get_encapsulated_payload(self):
        ...
        has_encapsulated_data = (
            self.type == TZSP.TYPE_RX_PACKET or self.type == TZSP.TYPE_TX_PACKET
        )  # noqa: E501
...
def _tzsp_handle_unknown_tag(payload, tag_type):
    ...
    if payload_len < 2:
        warning(
            "invalid or unknown tag type (%i) and too short packet - "
            "treat remaining data as Raw",
            tag_type,
        )
        return Raw
...
class TZSPTagContentionFree(_TZSPTag):
    ...
    fields_desc = [
        ByteEnumField(
            "type", _TZSPTag.TAG_TYPE_CONTENTION_FREE, _TZSPTag.TAG_TYPES
        ),  # noqa: E501
        ByteField("len", 1),
...
class TZSPTagError(_TZSPTag):
    ...
    fields_desc = [
        ...
        ByteField("len", 1),
        YesNoByteField(
            "fcs_error", NO, config={"no": NO, "yes": YES, "reserved": (YES + 1, 0xFF)}
        ),  # noqa: E501
    ]
...
class TZSPTagRXChannel(_TZSPTag):
    ...
    fields_desc = [
        ByteEnumField(
            "type", _TZSPTag.TAG_TYPE_RX_CHANNEL, _TZSPTag.TAG_TYPES
        ),  # noqa: E501
        ByteField("len", 1),
...
class TZSPTagPacketCount(_TZSPTag):
    ...
    fields_desc = [
        ByteEnumField(
            "type", _TZSPTag.TAG_TYPE_PACKET_COUNT, _TZSPTag.TAG_TYPES
        ),  # noqa: E501
        ByteField("len", 4),
...
class TZSPTagRXFrameLength(_TZSPTag):
    ...
    fields_desc = [
        ByteEnumField(
            "type", _TZSPTag.TAG_TYPE_RX_FRAME_LENGTH, _TZSPTag.TAG_TYPES
        ),  # noqa: E501
        ByteField("len", 2),
...
class TZSPTagWlanRadioHdrSerial(_TZSPTag):
    ...
    fields_desc = [
        ByteEnumField(
            "type", _TZSPTag.TAG_TYPE_WLAN_RADIO_HDR_SERIAL, _TZSPTag.TAG_TYPES
        ),  # noqa: E501
...
_TZSP_TAG_CLASSES = {
    ...
    _TZSPTag.TAG_TYPE_RAW_RSSI: {
        1: TZSPTagRawRSSIByte,
