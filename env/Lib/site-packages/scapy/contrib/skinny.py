...
class SkinnyDateTimeField(StrFixedLenField):
    ...
    def m2i(self, pkt, s):
        year, month, dow, day, hour, min, sec, millisecond = struct.unpack(
            "<8I", s
        )  # noqa: E501
...
class SkinnyMessageCallState(Packet):
    ...
    fields_desc = [
        LEIntEnumField("state", 1, skinny_callstates),
...
class SkinnyMessageDialedNumber(Packet):
    name = "dialed number"
    fields_desc = [
        StrFixedLenField("number", "1337", 24),
        LEIntField("instance", 1),
        LEIntField("callid", 0),
    ]
...
class SkinnyMessageCallInfo(Packet):
    ...
    fields_desc = [
        ...
        FlagsField(
            "restriction", 0, 16, _skinny_message_callinfo_restrictions
        ),  # noqa: E501
...
class SkinnyMessageOpenReceiveChannelAck(Packet):
    name = "open receive channel"
    fields_desc = [
        LEIntEnumField("status", 0, _skinny_receive_channel_status),
