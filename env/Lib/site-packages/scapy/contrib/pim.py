...
class _PIMGenericTlvBase(Packet):
    fields_desc = [
        ...
        BoundStrLenField("value", "", length_from=lambda pkt: pkt.length),
    ]
...
class PIMv2HelloStateRefresh(_PIMv2GenericHello):
    ...
    fields_desc = [
        ...
        FieldLenField("length", None, length_of="value", fmt="!H"),
        PacketListField(
            "value", PIMv2HelloStateRefreshValue(), PIMv2HelloStateRefreshValue
        ),
    ]
...
class PIMv2GroupAddrs(_PIMGenericTlvBase):
    ...
    fields_desc = [
        ...
        PacketListField(
            "join_ips", [], PIMv2JoinAddrs, count_from=lambda x: x.num_joins
        ),
        PacketListField(
            "prune_ips", [], PIMv2PruneAddrs, count_from=lambda x: x.num_prunes
        ),
    ]
...
class PIMv2JoinPrune(_PIMGenericTlvBase):
    ...
    fields_desc = [
        ...
        PacketListField(
            "jp_ips", [], PIMv2GroupAddrs, count_from=lambda pkt: pkt.num_group
        ),
    ]
