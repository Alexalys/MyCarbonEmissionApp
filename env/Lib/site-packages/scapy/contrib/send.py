...
class ICMPv6NDOptNonce(_ICMPv6NDGuessPayload, Packet):
    ...
    fields_desc = [
        ...
        FieldLenField(
            ...
            length_of="nonce",
            fmt="B",
            adjust=lambda pkt, x: int(round((x + 2) / 8.0)),
        ),  # noqa: E501
...
class ICMPv6NDOptRsaSig(_ICMPv6NDGuessPayload, Packet):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "len",
            None,
            length_of="signature_pad",
            fmt="B",
            adjust=lambda pkt, x: (x + 20) // 8,
        ),  # noqa: E501
...
class CGA_Params(Packet):
    ...
    fields_desc = [
        ...
        ByteField("cc", 0),
        PacketField("pubkey", X509_SubjectPublicKeyInfo(), X509_SubjectPublicKeyInfo),
    ]
...
class ICMPv6NDOptCGA(_ICMPv6NDGuessPayload, Packet):
    ...
    fields_desc = [
        ...
        FieldLenField(
            ...
            fmt="B",
            adjust=lambda pkt, x: (x + pkt.padlength + 4) // 8,
        ),  # noqa: E501
