...
class OBD_PID41(OBD_Packet):
    ...
    fields_desc = [
        ...
        FlagsField(
            "continuous_tests_ready", 0, 3, ["misfire", "fuelSystem", "components"]
        ),
        BitField("reserved2", 0, 1),
        FlagsField(
            "continuous_tests_supported", 0, 3, ["misfire", "fuelSystem", "components"]
        ),
        FlagsField(
...
class OBD_PID4F(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField("intake_manifold_absolute_pressure", 0, scaling=10, unit="kPa"),
    ]
...
class _OBD_SensorTrimPacket1(OBD_Packet):
    fields_desc = [
        ScalingField("bank1", 0, scaling=100 / 128.0, offset=-100, unit="%"),
        ScalingField("bank3", 0, scaling=100 / 128.0, offset=-100, unit="%"),
    ]


class _OBD_SensorTrimPacket2(OBD_Packet):
    fields_desc = [
        ScalingField("bank2", 0, scaling=100 / 128.0, offset=-100, unit="%"),
        ScalingField("bank4", 0, scaling=100 / 128.0, offset=-100, unit="%"),
    ]
...
class OBD_PID5D(OBD_Packet):
    ...
    fields_desc = [
        ScalingField("data", 0, scaling=1 / 128.0, offset=-210, unit="deg.", fmt="H")
    ]
