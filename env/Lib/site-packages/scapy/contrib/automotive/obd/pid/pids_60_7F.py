...
class OBD_PID6A(OBD_Packet):
    name = (
        "PID_6A_CommandedDieselIntakeAirFlowControl" "AndRelativeIntakeAirFlowPosition"
    )
    fields_desc = [
        ...
        ScalingField(
            "commanded_intake_air_flow_a_control", 0, scaling=100 / 255.0, unit="%"
        ),
        ScalingField(
            "relative_intake_air_flow_a_position", 0, scaling=100 / 255.0, unit="%"
        ),
        ScalingField(
            "commanded_intake_air_flow_b_control", 0, scaling=100 / 255.0, unit="%"
        ),
        ScalingField(
            "relative_intake_air_flow_b_position", 0, scaling=100 / 255.0, unit="%"
        ),
    ]
...
class OBD_PID6C(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField(
            "commanded_throttle_actuator_a_control", 0, scaling=100 / 255.0, unit="%"
        ),
        ScalingField("relative_throttle_a_position", 0, scaling=100 / 255.0, unit="%"),
        ScalingField(
            "commanded_throttle_actuator_b_control", 0, scaling=100 / 255.0, unit="%"
        ),
...
class OBD_PID6D(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField(
            "commanded_fuel_rail_pressure", 0, scaling=10, unit="kPa", fmt="H"
        ),
...
class OBD_PID6E(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField(
            "commanded_injection_control_pressure", 0, scaling=10, unit="kPa", fmt="H"
        ),
...
class OBD_PID70(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField(
            "commanded_boost_pressure_a", 0, scaling=0.03125, unit="kPa", fmt="H"
        ),
        ScalingField(
            "boost_pressure_sensor_a", 0, scaling=0.03125, unit="kPa", fmt="H"
        ),
        ScalingField(
            "commanded_boost_pressure_b", 0, scaling=0.03125, unit="kPa", fmt="H"
        ),
        ScalingField(
            "boost_pressure_sensor_b", 0, scaling=0.03125, unit="kPa", fmt="H"
        ),
    ]
...
class OBD_PID71(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField(
            "variable_geometry_turbo_a_position", 0, scaling=100 / 255.0, unit="%"
        ),
        ScalingField(
        ...
        ScalingField(
            "variable_geometry_turbo_b_position", 0, scaling=100 / 255.0, unit="%"
        ),
    ]
...
class OBD_PID72(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField(
            "commanded_wastegate_a_position", 0, scaling=100 / 255.0, unit="%"
        ),
        ScalingField("wastegate_a_position", 0, scaling=100 / 255.0, unit="%"),
        ScalingField(
            "commanded_wastegate_b_position", 0, scaling=100 / 255.0, unit="%"
        ),
...
class OBD_PID75(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField(
            "turbocharger_a_compressor_inlet_temperature", 0, unit="deg. C", offset=-40
        ),
        ScalingField(
            "turbocharger_a_compressor_outlet_temperature", 0, unit="deg. C", offset=-40
        ),
        ScalingField(
...
class _OBD_PID_DieselParticulateFilter(OBD_Packet):
    fields_desc = [
        ...
        ScalingField(
            "delta_pressure", 0, unit="kPa", offset=-327.68, scaling=0.01, fmt="H"
        ),
