...
class OBD_S01_PR(Packet):
    ...
    def answers(self, other):
        return isinstance(other, OBD_S01) and all(
            r.pid in other.pid for r in self.data_records
        )
...
class OBD_S02_PR(Packet):
    ...
    def answers(self, other):
        return isinstance(other, OBD_S02) and all(
            r.pid in [o.pid for o in other.requests] for r in self.data_records
        )
