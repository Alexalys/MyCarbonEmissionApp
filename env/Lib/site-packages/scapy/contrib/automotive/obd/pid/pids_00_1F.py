...
class OBD_PID01(OBD_Packet):
    ...
    fields_desc = [
        ...
        FlagsField(
            "continuous_tests_supported", 0, 3, ["misfire", "fuel_system", "components"]
        ),
        FlagsField(
...
class OBD_PID06(OBD_Packet):
    ...
    fields_desc = [
        ScalingField("data", 0, scaling=100 / 128.0, unit="%", offset=-100.0)
    ]
...
class _OBD_PID14_1B(OBD_Packet):
    fields_desc = [
        ...
        ScalingField("trim", 0, scaling=100 / 128.0, unit="%", offset=-100),
    ]
