...
class OBD_S09_PR(Packet):
    ...
    def answers(self, other):
        return isinstance(other, OBD_S09) and all(
            r.iid in other.iid for r in self.data_records
        )
...
class OBD_IID02(OBD_Packet):
    ...
    fields_desc = [
        FieldLenField(
            "count", None, count_of="vehicle_identification_numbers", fmt="B"
        ),
        FieldListField(
...
class OBD_IID04(OBD_Packet):
    ...
    fields_desc = [
        FieldLenField("count", None, count_of="calibration_identifications", fmt="B"),
        FieldListField(
...
class OBD_IID06(OBD_Packet):
    ...
    fields_desc = [
        FieldLenField(
            "count", None, count_of="calibration_verification_numbers", fmt="B"
        ),
        FieldListField(
...
class OBD_IID08(OBD_Packet):
    ...
    fields_desc = [
        ...
        FieldListField("data", [], ShortField("", 0), count_from=lambda pkt: pkt.count),
    ]
