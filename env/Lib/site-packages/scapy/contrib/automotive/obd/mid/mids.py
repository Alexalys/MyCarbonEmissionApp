...
def _unit_and_scaling_fields(name):
    return [
        ...
        (
            ScalingField(name, -40, scaling=0.1, unit="deg. C", offset=-40, fmt="H"),
        ...
        (
            ScalingField(name, 0, scaling=0.01, unit="%", offset=-327.68, fmt="H"),
...
class OBD_MIDXX(OBD_Packet):
    ...
    fields_desc = [
        ...
        MultipleTypeField(
            _unit_and_scaling_fields("test_value"), ShortField("test_value", 0)
        ),
        MultipleTypeField(
            _unit_and_scaling_fields("min_limit"), ShortField("min_limit", 0)
        ),
        MultipleTypeField(
...
class OBD_S06_PR(Packet):
    ...
    def answers(self, other):
        return isinstance(other, OBD_S06) and all(
            r.mid in other.mid for r in self.data_records
        )
