...
def GMLAN_RDBPIPR_get_log(self):
    # type: (Packet) -> Tuple[str, Any]
    return self.sprintf("%GMLAN.service%"), self.sprintf(
        "%GMLAN_RDBPIPR.parameterIdentifier%"
    )
...
def GMLAN_RMBAPR_get_log(self):
    # type: (Packet) -> Tuple[str, Any]
    return self.sprintf("%GMLAN.service%"), (
        self.sprintf("%GMLAN_RMBAPR.memoryAddress%"),
        self.dataRecord,
    )
...
def GMLAN_DDM_get_log(self):
    # type: (Packet) -> Tuple[str, Any]
    return self.sprintf("%GMLAN.service%"), (
        self.sprintf("%GMLAN_DDM.DPIDIdentifier%"),
        self.PIDData,
    )
...
def GMLAN_TD_get_log(self):
    # type: (Packet) -> Tuple[str, Any]
    return self.sprintf("%GMLAN.service%"), (
        self.sprintf("%GMLAN_TD.subfunction%"),
...
def GMLAN_WDBI_get_log(self):
    # type: (Packet) -> Tuple[str, Any]
    return self.sprintf("%GMLAN.service%"), (
        self.sprintf("%GMLAN_WDBI.dataIdentifier%"),
        self.dataRecord,
    )
