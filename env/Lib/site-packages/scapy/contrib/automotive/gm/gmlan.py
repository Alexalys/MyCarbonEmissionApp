...
class GMLAN_RFRD(Packet):
    ...
    fields_desc = [
        ...
        ConditionalField(
            PacketField("dtc", b"", GMLAN_DTC), lambda pkt: pkt.subfunction == 0x02
        ),
    ]
...
class GMLAN_RDBPIPR(Packet):
    ...
    def answers(self, other):
        return (
            isinstance(other, GMLAN_RDBPI)
            and self.parameterIdentifier in other.identifiers
        )
...
class GMLAN_RMBA(Packet):
    ...
    fields_desc = [
        MultipleTypeField(
            [
                (XShortField("memoryAddress", 0), lambda pkt: GMLAN.determine_len(2)),
                (X3BytesField("memoryAddress", 0), lambda pkt: GMLAN.determine_len(3)),
...
class GMLAN_RMBAPR(Packet):
    ...
    def answers(self, other):
        return (
            isinstance(other, GMLAN_RMBA) and other.memoryAddress == self.memoryAddress
        )
...
class GMLAN_SA(Packet):
    ...
    fields_desc = [
        ByteEnumField("subfunction", 0, subfunctions),
        ConditionalField(
            XShortField("securityKey", 0), lambda pkt: pkt.subfunction % 2 == 0
        ),
    ]
...
class GMLAN_SAPR(Packet):
    ...
    fields_desc = [
        ...
        ConditionalField(
            XShortField("securitySeed", 0), lambda pkt: pkt.subfunction % 2 == 1
        ),
    ]
...
class GMLAN_DDMPR(Packet):
    ...
    def answers(self, other):
        return (
            isinstance(other, GMLAN_DDM) and other.DPIDIdentifier == self.DPIDIdentifier
        )
...
class GMLAN_RD(Packet):
    ...
    fields_desc = [
        ...
        MultipleTypeField(
            [
                (XShortField("memorySize", 0), lambda pkt: GMLAN.determine_len(2)),
                (X3BytesField("memorySize", 0), lambda pkt: GMLAN.determine_len(3)),
                (XIntField("memorySize", 0), lambda pkt: GMLAN.determine_len(4)),
            ],
...
class GMLAN_TD(Packet):
    ...
    fields_desc = [
        ...
        MultipleTypeField(
            [
                (XShortField("startingAddress", 0), lambda pkt: GMLAN.determine_len(2)),
                (
                    X3BytesField("startingAddress", 0),
                    lambda pkt: GMLAN.determine_len(3),
                ),
                (XIntField("startingAddress", 0), lambda pkt: GMLAN.determine_len(4)),
            ],
...
class GMLAN_NR(Packet):
    ...
    def answers(self, other):
        return self.requestServiceId == other.service and (
            self.returnCode != 0x78
            or conf.contribs["GMLAN"]["treat-response-pending-as-answer"]
        )
