...
class Graph(object):
    ...
    def __init__(self):
        ...
        self.__transition_functions = (
            {}
        )  # type: Dict[_Edge, Optional["_TransitionTuple"]]  # noqa: E501
    ...
    def render(self, filename="SystemStateGraph.gv", view=True):
        ...
        ps = Digraph(
            name="SystemStateGraph",
            node_attr={"fillcolor": "lightgrey", "style": "filled", "shape": "box"},
    ...
    def dijkstra(graph, initial, end):
        ...
        shortest_paths = {
            initial: (None, 0)
        }  # type: Dict[EcuState, Tuple[Optional[EcuState], int]]  # noqa: E501
        ...
        while current_node != end:
            ...
            for next_node in destinations:
                weight = (
                    graph.weights[(current_node, next_node)] + weight_to_current_node
                )
