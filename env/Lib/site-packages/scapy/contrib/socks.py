    ...
    def guess_payload_class(self, pkt):
        ...
        if self.vn == 0x5:
            ...
            if s_port:
                return SOCKS4Reply
        warning(
            "No TCP underlayer, or dport/sport not in "
            "conf.contribs['socks']['serverports']. "
...
class SOCKS4Reply(Packet):
    ...
    ] + SOCKS4Request.fields_desc[
        1:-2
    ]  # Re-use dstport, dst and userid
...
class SOCKS5UDP(Packet):
    ...
    fields_desc = [
        ShortField("res", 0),
        ByteField("frag", 0),
    ] + SOCKS5Request.fields_desc[
        2:
    ]  # Re-use the atyp, addr and port fields
