...
class RPLOptRIO(_RPLGuessOption):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "len", None, length_of="prefix", fmt="B", adjust=lambda pkt, x: x + 6
        ),
        ByteField("plen", None),
        BitField("res1", 0, 3),
...
class RPLOptTgt(_RPLGuessOption):
    ...
    name = "RPL Target"
    fields_desc = [
        ByteEnumField("otype", 5, RPLOPTSSTR),
        FieldLenField(
            "len", None, length_of="prefix", fmt="B", adjust=lambda pkt, x: x + 2
        ),
        ByteField("flags", 0),
        ByteField("plen", 0),
        _IP6PrefixField("prefix", None),
...
class RPLOptTIO(_RPLGuessOption):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "len", None, length_of="parentaddr", fmt="B", adjust=lambda pkt, x: x + 4
        ),
        BitField("E", 0, 1),
        BitField("flags", 0, 7),
...
class RPLOptTgtDesc(_RPLGuessOption):
    ...
    fields_desc = [
        ByteEnumField("otype", 9, RPLOPTSSTR),
        ByteField("len", 4),
...
class RPLOptPadN(_RPLGuessOption):
    ...
    name = "PadN"
    fields_desc = [
        ByteEnumField("otype", 0x01, RPLOPTSSTR),
...
class RPLDAO(_RPLGuessMsgType, _RPLGuessOption):
    ...
    fields_desc = [
        ...
        ByteField("reserved", 0),
        ByteField("daoseq", 1),
        ConditionalField(IP6Field("dodagid", None), lambda pkt: pkt.D == 1),
    ]
