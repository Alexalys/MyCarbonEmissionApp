...
class SuperSocket:
            ...
            for cmsg_lvl, cmsg_type, cmsg_data in ancdata:
                ...
                if cmsg_lvl == SOL_PACKET and cmsg_type == PACKET_AUXDATA:
                    ...
                    try:
                        ...
                        return pkt, sa_ll, timestamp
                    if (
                        auxdata.tp_vlan_tci != 0
                        or auxdata.tp_status & TP_STATUS_VLAN_VALID
                    ):
                        # Insert VLAN tag
    ...
    def sr(self, *args, **kargs):
        ...
        ans, unans = sendrecv.sndrcv(
            self, *args, **kargs
        )  # type: SndRcvList, PacketList  # noqa: E501
        return ans, unans
    ...
    def sniff(self, *args, **kargs):
        ...
        pkts = sendrecv.sniff(
            opened_socket=self, *args, **kargs
        )  # type: PacketList  # noqa: E501
        return pkts
...
class SSLStreamSocket(StreamSocket):
    ...
    def recv(self, x=65535):
        ...
        if pkt is not None:
            ...
            if pad is not None and pad.underlayer is not None:
                del pad.underlayer.payload
            while pad is not None and not isinstance(
                pad, scapy.packet.NoPayload
            ):  # noqa: E501
                x -= len(pad.load)
                pad = pad.payload
