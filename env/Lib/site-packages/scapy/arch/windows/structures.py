...
def get_service_status(service):
    ...
    schSCManager = OpenSCManagerW(
        None, None, SERVICE_QUERY_STATUS  # Local machine  # SERVICES_ACTIVE_DATABASE
    )
...
_GetAdaptersAddresses = WINFUNCTYPE(
    ULONG, ULONG, ULONG, POINTER(VOID), LP_IP_ADAPTER_ADDRESSES, POINTER(ULONG)
...
_GetIpForwardTable = WINFUNCTYPE(DWORD, PMIB_IPFORWARDTABLE, POINTER(ULONG), BOOL)(
...
if not WINDOWS_XP:
    ...
    _GetIpForwardTable2 = WINFUNCTYPE(ULONG, USHORT, POINTER(PMIB_IPFORWARD_TABLE2))(
