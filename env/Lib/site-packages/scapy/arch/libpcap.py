        ...
        if WINDOWS:
            ...
            if b"winpcap" in version.lower():
                if os.path.exists(NPCAP_PATH + "\\wpcap.dll"):
                    ...
                    warning(
                        "WinPcap is now deprecated (not maintained). "
                ...
                conf.loopback_name = (
                    conf.loopback_name
                ) = "Npcap Loopback Adapter"  # noqa: E501
...
if conf.use_pcap:
    ...
    class _PcapWrapper_libpcap:  # noqa: F811
        ...
        def setfilter(self, f):
            ...
            if (
                pcap_compile(self.pcap, byref(self.bpf_program), filter_exp, 0, -1)
                == -1
            ):  # noqa: E501
    ...
    class L2pcapListenSocket(_L2libpcapSocket):
        ...
        def __init__(
            self, iface=None, type=ETH_P_ALL, promisc=None, filter=None, monitor=None
        ):  # noqa: E501
            ...
            if (
                type == ETH_P_ALL
            ):  # Do not apply any filter if Ethernet type is given  # noqa: E501
    ...
    class L2pcapSocket(_L2libpcapSocket):
        ...
        def __init__(
            ...
            if nofilter:
                if (
                    type != ETH_P_ALL
                ):  # PF_PACKET stuff. Need to emulate this for pcap  # noqa: E501
