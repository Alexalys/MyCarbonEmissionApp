    ...
    X509_RDN(
        rdn=[
            X509_AttributeTypeAndValue(
                type="2.5.4.10", value=ASN1_PRINTABLE_STRING("Scapy, Inc.")
            )
        ]
    ),
    X509_RDN(
        rdn=[
            X509_AttributeTypeAndValue(
                type="2.5.4.3", value=ASN1_PRINTABLE_STRING("Scapy Default Name")
            )
        ]
    ),
]
...
class X509_GeneralName(ASN1_Packet):
    ...
    ASN1_root = ASN1F_CHOICE(
        ...
        ASN1F_PACKET(
            "x400Address", None, X509_X400Address, explicit_tag=0xA3  # noqa: E501
        ),
        ASN1F_PACKET(
            "directoryName", None, X509_DirectoryName, explicit_tag=0xA4  # noqa: E501
        ),
        ASN1F_PACKET(
            "ediPartyName", None, X509_EDIPartyName, explicit_tag=0xA5  # noqa: E501
        ),
        ASN1F_PACKET(
            "uniformResourceIdentifier", None, X509_URI, implicit_tag=0x86  # noqa: E501
        ),
        ASN1F_PACKET("ipAddress", None, X509_IPAddress, implicit_tag=0x87),
        ASN1F_PACKET(
            "registeredID", None, X509_RegisteredID, implicit_tag=0x88  # noqa: E501
        ),
    )
...
class X509_AlgorithmIdentifier(ASN1_Packet):
    ...
    ASN1_root = ASN1F_SEQUENCE(
        ...
        ASN1F_optional(
            ASN1F_CHOICE("parameters", ASN1_NULL(0), ASN1F_NULL, ECParameters)
        ),
    )
...
class ASN1F_X509_SubjectPublicKeyInfoRSA(ASN1F_SEQUENCE):
    def __init__(self, **kargs):
        seq = [
            ...
            ASN1F_BIT_STRING_ENCAPS("subjectPublicKey", RSAPublicKey(), RSAPublicKey),
        ]
        ASN1F_SEQUENCE.__init__(self, *seq, **kargs)
...
_default_issuer = [
    ...
    X509_RDN(
        rdn=[
            X509_AttributeTypeAndValue(
                type="2.5.4.3", value=ASN1_PRINTABLE_STRING("Scapy Default Issuer")
            )
        ]
    ),
]
...
_default_subject = [
    ...
    X509_RDN(
        rdn=[
            X509_AttributeTypeAndValue(
                type="2.5.4.3", value=ASN1_PRINTABLE_STRING("Scapy Default Subject")
            )
        ]
    ),
]
...
class OCSP_RevokedInfo(ASN1_Packet):
    ...
    ASN1_root = ASN1F_SEQUENCE(
        ...
        ASN1F_optional(
            ASN1F_PACKET(
                "revocationReason", None, X509_ExtReasonCode, explicit_tag=0x80
            )
        ),
    )
