...
class _SCTPChunkGuessPayload:
    def default_payload_class(self, p):
        if len(p) < 4:
            ...
            t = orb(p[0])
            return globals().get(
                sctpchunktypescls.get(t, "Raw"), conf.raw_layer
            )  # noqa: E501


class SCTP(_SCTPChunkGuessPayload, Packet):
    fields_desc = [
        ShortField("sport", None),
...
class ChunkParamField(PacketListField):
    ...
    def m2i(self, p, m):
        ...
        if len(m) >= 4:
            ...
            cls = globals().get(
                sctpchunkparamtypescls.get(t, "Raw"), conf.raw_layer
            )  # noqa: E501
        return cls(m)
...
class SCTPChunkParamStateCookie(_SCTPChunkParam, Packet):
    fields_desc = [
        ...
        PadField(
            StrLenField("cookie", "", length_from=lambda pkt: pkt.len - 4),
            4,
            padwith=b"\x00",
        ),
    ]
...
class SCTPChunkParamUnrocognizedParam(_SCTPChunkParam, Packet):
    fields_desc = [
        ...
        PadField(
            StrLenField("param", "", length_from=lambda pkt: pkt.len - 4),
            4,
            padwith=b"\x00",
        ),
    ]
...
class SCTPChunkParamHostname(_SCTPChunkParam, Packet):
    fields_desc = [
        ...
        PadField(
            StrLenField("hostname", "", length_from=lambda pkt: pkt.len - 4),
            4,
            padwith=b"\x00",
        ),
    ]
...
class SCTPChunkParamSupportedAddrTypes(_SCTPChunkParam, Packet):
    fields_desc = [
        ...
        FieldLenField(
            "len", None, length_of="addr_type_list", adjust=lambda pkt, x: x + 4
        ),
        PadField(
            FieldListField(
                "addr_type_list",
...
class SCTPChunkParamRandom(_SCTPChunkParam, Packet):
    fields_desc = [
        ...
        PadField(
            StrLenField("random", RandBin(32), length_from=lambda pkt: pkt.len - 4),
            4,
            padwith=b"\x00",
        ),
    ]
...
class SCTPChunkParamRequestedHMACFunctions(_SCTPChunkParam, Packet):
    fields_desc = [
        ...
        FieldLenField(
            "len", None, length_of="HMAC_functions_list", adjust=lambda pkt, x: x + 4
        ),
        PadField(
            FieldListField(
                "HMAC_functions_list",
...
class SCTPChunkParamSupportedExtensions(_SCTPChunkParam, Packet):
    fields_desc = [
        ...
        FieldLenField(
            "len", None, length_of="supported_extensions", adjust=lambda pkt, x: x + 4
        ),
        PadField(
            FieldListField(
                ...
                ByteEnumField(
                    "supported_extensions", None, sctpchunktypes  # noqa: E501
                ),
                length_from=lambda pkt: pkt.len - 4,
            ),  # noqa: E501
            4,
...
class SCTPChunkParamErrorIndication(_SCTPChunkParam, Packet):
    fields_desc = [
        ...
        FieldLenField(
            "len", None, length_of="error_causes", adjust=lambda pkt, x: x + 8
        ),
        XIntField("correlation_id", None),
        PadField(
            StrLenField("error_causes", "", length_from=lambda pkt: pkt.len - 4),
            4,
            padwith=b"\x00",
        ),
    ]
...
class SCTPChunkData(_SCTPChunkGuessPayload, Packet):
    ...
    fields_desc = [
        ...
        BitField("ending", 0, 1),
        FieldLenField(
            "len", None, length_of="data", adjust=lambda pkt, x: x + 16
        ),  # noqa: E501
        XIntField("tsn", None),
        XShortField("stream_id", None),
        XShortField("stream_seq", None),
        IntEnumField(
            "proto_id", None, SCTP_PAYLOAD_PROTOCOL_INDENTIFIERS
        ),  # noqa: E501
        PadField(
            StrLenField(
                "data", None, length_from=lambda pkt: pkt.len - 16
            ),  # noqa: E501
            4,
            padwith=b"\x00",
        ),
...
class SCTPChunkInit(_SCTPChunkGuessPayload, Packet):
    fields_desc = [
        ...
        FieldLenField(
            "len", None, length_of="params", adjust=lambda pkt, x: x + 20
        ),  # noqa: E501
...
class SCTPChunkSACK(_SCTPChunkGuessPayload, Packet):
    fields_desc = [
        ...
        FieldListField(
            ...
            count_from=lambda pkt: pkt.n_gap_ack,
        ),  # noqa: E501
        FieldListField(
            "dup_tsn_list",
            [],
            XIntField("dup_tsn", None),
            count_from=lambda pkt: pkt.n_dup_tsn,
        ),  # noqa: E501
    ]
...
class SCTPChunkHeartbeatReq(_SCTPChunkGuessPayload, Packet):
    fields_desc = [
        ...
        XByteField("flags", None),
        FieldLenField(
            "len", None, length_of="params", adjust=lambda pkt, x: x + 4
        ),  # noqa: E501
        ChunkParamField(
...
class SCTPChunkAbort(_SCTPChunkGuessPayload, Packet):
    fields_desc = [
        ...
        BitField("TCB", 0, 1),
        FieldLenField(
            "len", None, length_of="error_causes", adjust=lambda pkt, x: x + 4
        ),  # noqa: E501
        PadField(
            StrLenField(
                "error_causes", "", length_from=lambda pkt: pkt.len - 4
            ),  # noqa: E501
            4,
            padwith=b"\x00",
        ),
...
class SCTPChunkCookieEcho(SCTPChunkError):
    fields_desc = [
        ...
        XByteField("flags", None),
        FieldLenField(
            "len", None, length_of="cookie", adjust=lambda pkt, x: x + 4
        ),  # noqa: E501
        PadField(
            StrLenField(
                "cookie", "", length_from=lambda pkt: pkt.len - 4
            ),  # noqa: E501
            4,
            padwith=b"\x00",
        ),
