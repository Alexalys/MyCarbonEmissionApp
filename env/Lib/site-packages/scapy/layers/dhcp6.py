...
class DUID_UUID(Packet):  # RFC 6355
    ...
    fields_desc = [
        ShortEnumField("type", 4, duidtypes),
...
class DHCP6OptUnknown(_DHCP6OptGuessPayload):  # A generic DHCPv6 Option
    ...
    fields_desc = [
        ShortEnumField("optcode", 0, dhcp6opts),
...
class DHCP6OptClientId(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.2
    ...
    fields_desc = [
        ShortEnumField("optcode", 1, dhcp6opts),
...
class DHCP6OptIA_NA(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.4
    ...
    fields_desc = [
        ...
        FieldLenField(
            "optlen", None, length_of="ianaopts", fmt="!H", adjust=lambda pkt, x: x + 12
        ),
        XIntField("iaid", None),
        IntField("T1", None),
        IntField("T2", None),
...
class DHCP6OptIA_TA(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.5
    ...
    fields_desc = [
        ...
        FieldLenField(
            "optlen", None, length_of="iataopts", fmt="!H", adjust=lambda pkt, x: x + 4
        ),
        XIntField("iaid", None),
        PacketListField(
            "iataopts",
...
class DHCP6OptPref(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.8
    ...
    fields_desc = [
        ShortEnumField("optcode", 7, dhcp6opts),
        ShortField("optlen", 1),
...
class DHCP6OptElapsedTime(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.9
    ...
    fields_desc = [
        ShortEnumField("optcode", 8, dhcp6opts),
        ShortField("optlen", 2),
...
class DHCP6OptAuth(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.11
    ...
    fields_desc = [
        ...
        FieldLenField(
            "optlen", None, length_of="authinfo", fmt="!H", adjust=lambda pkt, x: x + 11
        ),
...
class DHCP6OptServerUnicast(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.12
    ...
    fields_desc = [
        ShortEnumField("optcode", 12, dhcp6opts),
...
class DHCP6OptStatusCode(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.13
    ...
    fields_desc = [
        ...
        FieldLenField(
            "optlen", None, length_of="statusmsg", fmt="!H", adjust=lambda pkt, x: x + 2
        ),
...
class DHCP6OptUserClass(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.15
    ...
    fields_desc = [
        ...
        FieldLenField("optlen", None, fmt="!H", length_of="userclassdata"),
        _UserClassDataField(
            "userclassdata", [], USER_CLASS_DATA, length_from=lambda pkt: pkt.optlen
        ),
    ]
...
class DHCP6OptVendorClass(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.16
    ...
    fields_desc = [
        ...
        FieldLenField(
            "optlen", None, length_of="vcdata", fmt="!H", adjust=lambda pkt, x: x + 4
        ),
        IntEnumField("enterprisenum", None, IANA_ENTERPRISE_NUMBERS),
        _VendorClassDataField(
            "vcdata", [], VENDOR_CLASS_DATA, length_from=lambda pkt: pkt.optlen - 4
        ),
    ]  # noqa: E501
...
class DHCP6OptVendorSpecificInfo(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.17
    ...
    fields_desc = [
        ...
        FieldLenField(
            "optlen", None, length_of="vso", fmt="!H", adjust=lambda pkt, x: x + 4
        ),
        IntEnumField("enterprisenum", None, IANA_ENTERPRISE_NUMBERS),
        _VendorClassDataField(
            "vso", [], VENDOR_SPECIFIC_OPTION, length_from=lambda pkt: pkt.optlen - 4
        ),
    ]  # noqa: E501
...
class DHCP6OptIfaceId(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.18
    ...
    fields_desc = [
        ShortEnumField("optcode", 18, dhcp6opts),
...
class DHCP6OptReconfMsg(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.19
    ...
    fields_desc = [
        ShortEnumField("optcode", 19, dhcp6opts),
        ShortField("optlen", 1),
        ByteEnumField("msgtype", 11, {5: "Renew Message", 11: "Information Request"}),
    ]
...
class DHCP6OptSIPDomains(_DHCP6OptGuessPayload):  # RFC3319
    ...
    fields_desc = [
        ShortEnumField("optcode", 21, dhcp6opts),
        FieldLenField("optlen", None, length_of="sipdomains"),
        DomainNameListField("sipdomains", [], length_from=lambda pkt: pkt.optlen),
    ]
...
class DHCP6OptSIPServers(_DHCP6OptGuessPayload):  # RFC3319
    ...
    fields_desc = [
        ShortEnumField("optcode", 22, dhcp6opts),
        FieldLenField("optlen", None, length_of="sipservers"),
        IP6ListField("sipservers", [], length_from=lambda pkt: pkt.optlen),
    ]
...
class DHCP6OptDNSServers(_DHCP6OptGuessPayload):  # RFC3646
    ...
    fields_desc = [
        ShortEnumField("optcode", 23, dhcp6opts),
        FieldLenField("optlen", None, length_of="dnsservers"),
        IP6ListField("dnsservers", [], length_from=lambda pkt: pkt.optlen),
    ]
...
class DHCP6OptDNSDomains(_DHCP6OptGuessPayload):  # RFC3646
    ...
    fields_desc = [
        ShortEnumField("optcode", 24, dhcp6opts),
...
class DHCP6OptIAPrefix(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.22
    ...
    fields_desc = [
        ...
        FieldLenField(
            "optlen", None, length_of="iaprefopts", adjust=lambda pkt, x: x + 25
        ),
        IntEnumField("preflft", 0, {0xFFFFFFFF: "infinity"}),
        IntEnumField("validlft", 0, {0xFFFFFFFF: "infinity"}),
        ...
        IP6Field(
            "prefix", "2001:db8::"
        ),  # At least, global and won't hurt  # noqa: E501
...
class DHCP6OptIA_PD(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.21
    ...
    fields_desc = [
        ...
        FieldLenField(
            "optlen", None, length_of="iapdopt", fmt="!H", adjust=lambda pkt, x: x + 12
        ),
        XIntField("iaid", None),
        IntField("T1", None),
        IntField("T2", None),
...
class DHCP6OptNISServers(_DHCP6OptGuessPayload):  # RFC3898
    ...
    fields_desc = [
        ShortEnumField("optcode", 27, dhcp6opts),
        FieldLenField("optlen", None, length_of="nisservers"),
        IP6ListField("nisservers", [], length_from=lambda pkt: pkt.optlen),
    ]
...
class DHCP6OptNISPServers(_DHCP6OptGuessPayload):  # RFC3898
    name = "DHCP6 Option - NIS+ Servers"
    fields_desc = [
        ShortEnumField("optcode", 28, dhcp6opts),
        FieldLenField("optlen", None, length_of="nispservers"),
        IP6ListField("nispservers", [], length_from=lambda pkt: pkt.optlen),
    ]
...
class DHCP6OptNISDomain(_DHCP6OptGuessPayload):  # RFC3898
    ...
    fields_desc = [
        ShortEnumField("optcode", 29, dhcp6opts),
...
class DHCP6OptNISPDomain(_DHCP6OptGuessPayload):  # RFC3898
    name = "DHCP6 Option - NIS+ Domain Name"
    fields_desc = [
        ShortEnumField("optcode", 30, dhcp6opts),
...
class DHCP6OptSNTPServers(_DHCP6OptGuessPayload):  # RFC4075
    ...
    fields_desc = [
        ShortEnumField("optcode", 31, dhcp6opts),
        FieldLenField("optlen", None, length_of="sntpservers"),
        IP6ListField("sntpservers", [], length_from=lambda pkt: pkt.optlen),
    ]
...
class DHCP6OptInfoRefreshTime(_DHCP6OptGuessPayload):  # RFC4242
    ...
    fields_desc = [
        ShortEnumField("optcode", 32, dhcp6opts),
        ShortField("optlen", 4),
...
class DHCP6OptBCMCSDomains(_DHCP6OptGuessPayload):  # RFC4280
    ...
    fields_desc = [
        ShortEnumField("optcode", 33, dhcp6opts),
        FieldLenField("optlen", None, length_of="bcmcsdomains"),
        DomainNameListField("bcmcsdomains", [], length_from=lambda pkt: pkt.optlen),
    ]
...
class DHCP6OptBCMCSServers(_DHCP6OptGuessPayload):  # RFC4280
    ...
    fields_desc = [
        ShortEnumField("optcode", 34, dhcp6opts),
        FieldLenField("optlen", None, length_of="bcmcsservers"),
        IP6ListField("bcmcsservers", [], length_from=lambda pkt: pkt.optlen),
    ]
...
class DHCP6OptGeoConfElement(Packet):
    fields_desc = [
        ...
        StrLenField("CAvalue", "", length_from=lambda pkt: pkt.CAlength),
    ]
...
class DHCP6OptRemoteID(_DHCP6OptGuessPayload):  # RFC4649
    ...
    fields_desc = [
        ...
        FieldLenField(
            "optlen", None, length_of="remoteid", adjust=lambda pkt, x: x + 4
        ),
        IntEnumField("enterprisenum", None, IANA_ENTERPRISE_NUMBERS),
...
class DHCP6OptPanaAuthAgent(_DHCP6OptGuessPayload):  # RFC5192
    ...
    fields_desc = [
        ShortEnumField("optcode", 40, dhcp6opts),
...
class DHCP6OptNewPOSIXTimeZone(_DHCP6OptGuessPayload):  # RFC4833
    ...
    fields_desc = [
        ShortEnumField("optcode", 41, dhcp6opts),
        FieldLenField("optlen", None, length_of="optdata"),
        StrLenField("optdata", "", length_from=lambda pkt: pkt.optlen),
    ]
...
class DHCP6OptNewTZDBTimeZone(_DHCP6OptGuessPayload):  # RFC4833
    ...
    fields_desc = [
        ShortEnumField("optcode", 42, dhcp6opts),
        FieldLenField("optlen", None, length_of="optdata"),
        StrLenField("optdata", "", length_from=lambda pkt: pkt.optlen),
    ]
...
class DHCP6OptRelayAgentERO(_DHCP6OptGuessPayload):  # RFC4994
    ...
    fields_desc = [
        ShortEnumField("optcode", 43, dhcp6opts),
...
class DHCP6OptLQClientLink(_DHCP6OptGuessPayload):  # RFC5007
    ...
    fields_desc = [
        ShortEnumField("optcode", 48, dhcp6opts),
        FieldLenField("optlen", None, length_of="linkaddress"),
        IP6ListField("linkaddress", [], length_from=lambda pkt: pkt.optlen),
    ]
...
class DHCP6OptBootFileUrl(_DHCP6OptGuessPayload):  # RFC5970
    ...
    fields_desc = [
        ShortEnumField("optcode", 59, dhcp6opts),
        FieldLenField("optlen", None, length_of="optdata"),
        StrLenField("optdata", "", length_from=lambda pkt: pkt.optlen),
    ]
...
class DHCP6OptClientArchType(_DHCP6OptGuessPayload):  # RFC5970
    ...
    fields_desc = [
        ShortEnumField("optcode", 61, dhcp6opts),
...
class DHCP6OptClientNetworkInterId(_DHCP6OptGuessPayload):  # RFC5970
    ...
    fields_desc = [
        ShortEnumField("optcode", 62, dhcp6opts),
        ShortField("optlen", 3),
        ByteField("iitype", 0),
        ByteField("iimajor", 0),
        ByteField("iiminor", 0),
...
class DHCP6OptERPDomain(_DHCP6OptGuessPayload):  # RFC6440
    ...
    fields_desc = [
        ShortEnumField("optcode", 65, dhcp6opts),
        FieldLenField("optlen", None, length_of="erpdomain"),
        DomainNameListField("erpdomain", [], length_from=lambda pkt: pkt.optlen),
    ]
...
class DHCP6OptRelaySuppliedOpt(_DHCP6OptGuessPayload):  # RFC6422
    ...
    fields_desc = [
        ShortEnumField("optcode", 66, dhcp6opts),
...
class DHCP6(_DHCP6OptGuessPayload):
    ...
    fields_desc = [
        ByteEnumField("msgtype", None, dhcp6types),
...
class DHCP6OptRelayMsg(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.10
    ...
    fields_desc = [
        ...
        FieldLenField("optlen", None, fmt="!H", length_of="message"),
        PacketLenField(
            "message", DHCP6(), _dhcp6_dispatcher, length_from=lambda p: p.optlen
        ),
    ]
...
class DHCP6_Advertise(DHCP6):
    ...
    def answers(self, other):
        return (
            isinstance(other, DHCP6_Solicit)
            and other.msgtype == 1
            and self.trid == other.trid
        )
...
class DHCP6_RelayForward(_DHCP6OptGuessPayload, Packet):
    ...
    fields_desc = [
        ByteEnumField("msgtype", 12, dhcp6types),
...
class DHCP6_RelayReply(DHCP6_RelayForward):
    ...
    def answers(self, other):
        return (
            isinstance(other, DHCP6_RelayForward)
            and self.hopcount == other.hopcount
            and self.linkaddr == other.linkaddr
            and self.peeraddr == other.peeraddr
        )
...
DHCPv6_am.parse_options( dns="2001:500::1035", domain="localdomain, local",
   ...
   If you have a need for others, just ask ... or provide a patch."""
    ...
    def parse_options(
        ...
        for o in [
            ...
            (
                ...
                "domain",
                24,
                lambda x: DHCP6OptDNSDomains(dnsdomains=x),
            ),  # noqa: E501
            (
                sntpservers,
                "sntpservers",
            ...
            (
                ...
                "bcmcsdomains",
                34,
                lambda x: DHCP6OptBCMCSDomains(bcmcsdomains=x),
            ),
        ]:  # noqa: E501
        ...
        try:
            addr = next(
                x for x in in6_getifaddr() if x[2] == iface and in6_islladdr(x[0])
            )  # noqa: E501
    ...
    def is_request(self, p):
        ...
        if (
            (p.msgtype == 1)
            or (p.msgtype == 6)  # Solicit
            or (p.msgtype == 4)  # Rebind
        ):  # Confirm
            if (DHCP6OptClientId not in p) or DHCP6OptServerId in p:
                return False

            if p.msgtype == 6 or p.msgtype == 4:  # Rebind  # Confirm
                # XXX We do not reply to Confirm or Rebind as we
                # XXX do not support address assignment
                return False

        elif (
            p.msgtype == 3 or p.msgtype == 5 or p.msgtype == 8  # Request  # Renew
        ):  # Release
            ...
            if p.msgtype == 5 or p.msgtype == 8:  # Renew  # Release
            ...
            while it:
                ...
                addrs += [
                    x.addr for x in lst if isinstance(x, DHCP6OptIAAddress)
                ]  # noqa: E501
                it = it.payload
    ...
    def print_reply(self, req, reply):
        ...
        print(
            "Sent %s answering to %s from %s%s" % (reptype, reqtype, reqsrc, vendor)
        )  # noqa: E501
