...
class SMBNetlogon_Protocol_Response_Tail_SAM(Packet):
    ...
    fields_desc = [
        ByteEnumField(
            "Command",
            0x17,
            {0x12: "SAM logon request", 0x17: "SAM Active directory Response"},
        ),  # noqa: E501
        ByteField("unused", 0),
        ShortField("Data1", 0),
...
class SMBNetlogon_Protocol_Response_Tail_LM20(Packet):
    ...
    fields_desc = [
        ByteEnumField(
            "Command", 0x06, {0x06: "LM 2.0 Response to logon request"}
        ),  # noqa: E501
        ByteField("unused", 0),
...
class SMBNegociate_Protocol_Response_Advanced_Security(Packet):
    ...
    fields_desc = [
        ...
        LEFieldLenField(
            "ByteCount", None, "SecurityBlob", adjust=lambda pkt, x: x - 16
        ),  # noqa: E501
        BitField("GUID", 0, 128),
...
class SMBSession_Setup_AndX_Request(Packet):
    ...
    fields_desc = [
        StrFixedLenField("Start", b"\xffSMB", 4),
        ByteEnumField(
            "Command", 0x73, {0x73: "SMB_COM_SESSION_SETUP_ANDX"}
        ),  # noqa: E501
        ByteField("Error_Class", 0),
        ByteField("Reserved", 0),
        LEShortField("Error_Code", 0),
        ...
        ByteEnumField(
            "AndXCommand", 0x75, {0x75: "SMB_COM_TREE_CONNECT_ANDX"}
        ),  # noqa: E501
        ...
        StrLenField(
            "ANSIPassword", "Pass", length_from=lambda x: x.ANSIPasswordLength
        ),  # noqa: E501
