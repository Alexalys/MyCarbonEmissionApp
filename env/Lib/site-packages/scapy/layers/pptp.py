...
class PPTP(Packet):
    ...
    fields_desc = [
        FieldLenField(
            "len", None, fmt="H", length_of="data", adjust=lambda p, x: x + 12
        ),
...
class PPTPEchoReply(PPTP):
    ...
    def answers(self, other):
        return (
            isinstance(other, PPTPEchoRequest) and other.identifier == self.identifier
        )  # noqa: E501
...
class PPTPOutgoingCallReply(PPTP):
    ...
    def answers(self, other):
        return (
            isinstance(other, PPTPOutgoingCallRequest)
            and other.call_id == self.peer_call_id
        )  # noqa: E501
...
class PPTPIncomingCallReply(PPTP):
    ...
    def answers(self, other):
        return (
            isinstance(other, PPTPIncomingCallRequest)
            and other.call_id == self.peer_call_id
        )  # noqa: E501
...
class PPTPIncomingCallConnected(PPTP):
    ...
    def answers(self, other):
        return (
            isinstance(other, PPTPIncomingCallReply)
            and other.call_id == self.peer_call_id
        )  # noqa: E501
