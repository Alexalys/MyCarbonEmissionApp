...
_tls_error_code = {
    ...
    2: "no_certificate",
    4: "bad_certificate",
    6: "unsupported_certificate_type",
}
...
class SSLv2Error(_SSLv2Handshake):
    ...
    fields_desc = [
        ByteEnumField("msgtype", 0, _sslv2_handshake_type),
...
class SSLv2ServerHello(_SSLv2Handshake):
    ...
    fields_desc = [
        ...
        _SSLv2CipherSuitesField(
            "ciphers", [], _tls_cipher_suites, length_from=lambda pkt: pkt.cipherslen
        ),  # noqa: E501
        XStrLenField(
            "connection_id", b"", length_from=lambda pkt: pkt.connection_idlen
        ),
    ]
...
class SSLv2ClientMasterKey(_SSLv2Handshake):
    ...
    fields_desc = [
        ...
        _SSLv2EncryptedKeyField(
            "encryptedkey", "", length_from=lambda pkt: pkt.encryptedkeylen
        ),  # noqa: E501
...
class SSLv2ServerVerify(_SSLv2Handshake):
    ...
    fields_desc = [
        ByteEnumField("msgtype", 5, _sslv2_handshake_type),
        XStrField("challenge", ""),
    ]
    ...
    def post_dissection(self, pkt):
        ...
        if s.sslv2_challenge is not None:
            if self.challenge != s.sslv2_challenge:
                ...
                log_runtime.info(
                    "TLS: invalid ServerVerify received [%s]", pkt_info
                )  # noqa: E501
...
class SSLv2RequestCertificate(_SSLv2Handshake):
    ...
    fields_desc = [
        ByteEnumField("msgtype", 7, _sslv2_handshake_type),
...
class SSLv2ClientCertificate(_SSLv2Handshake):
    ...
    def build(self, *args, **kargs):
        ...
        test = (
            sig is None
            and s.sslv2_key_material is not None
    ...
    def post_dissection_tls_session_update(self, msg_str):
        ...
        if test:
            ...
            if not sig_test:
                ...
                log_runtime.info(
                    "TLS: invalid client CertificateVerify signature [%s]", pkt_info
                )  # noqa: E501
...
class SSLv2ClientFinished(_SSLv2Handshake):
    ...
    fields_desc = [
        ByteEnumField("msgtype", 3, _sslv2_handshake_type),
    ...
    def post_dissection(self, pkt):
        ...
        if s.sslv2_connection_id is not None:
            if self.connection_id != s.sslv2_connection_id:
                pkt_info = pkt.firstlayer().summary()
                log_runtime.info(
                    "TLS: invalid client Finished received [%s]", pkt_info
                )  # noqa: E501
...
class SSLv2ServerFinished(_SSLv2Handshake):
    ...
    fields_desc = [
        ByteEnumField("msgtype", 6, _sslv2_handshake_type),
        XStrField("sid", ""),
    ]
...
_sslv2_handshake_cls = {
    0: SSLv2Error,
    1: SSLv2ClientHello,
    2: SSLv2ClientMasterKey,
    3: SSLv2ClientFinished,
    4: SSLv2ServerHello,
    5: SSLv2ServerVerify,
    6: SSLv2ServerFinished,
    7: SSLv2RequestCertificate,
