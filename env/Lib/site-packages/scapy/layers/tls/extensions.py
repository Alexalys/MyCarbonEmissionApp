...
class TLS_Ext_Unknown(_GenericTLSSessionInheritance):
    ...
    fields_desc = [
        ...
        StrLenField("val", "", length_from=lambda pkt: pkt.len),
    ]
...
class TLS_Ext_PrettyPacketList(TLS_Ext_Unknown):
    ...
    def _show_or_dump(
        self, dump=False, indent=3, lvl="", label_lvl="", first_call=True
    ):
...
class ServerName(Packet):
    name = "HostName"
    fields_desc = [
        ByteEnumField("nametype", 0, _tls_server_name_types),
        FieldLenField("namelen", None, length_of="servername"),
        StrLenField("servername", "", length_from=lambda pkt: pkt.namelen),
    ]
...
class TLS_Ext_ServerName(TLS_Ext_PrettyPacketList):  # RFC 4366
    ...
    fields_desc = [
        ...
        FieldLenField(
            "len", None, length_of="servernames", adjust=lambda pkt, x: x + 2
        ),
        ServerLenField("servernameslen", None, length_of="servernames"),
        ServerListField(
            "servernames", [], ServerName, length_from=lambda pkt: pkt.servernameslen
        ),
    ]
...
class TLS_Ext_EncryptedServerName(TLS_Ext_PrettyPacketList):
    ...
    fields_desc = [
        ...
        XStrLenField(
            "record_digest", "", length_from=lambda pkt: pkt.record_digest_len
        ),
        FieldLenField("encrypted_sni_len", None, length_of="encrypted_sni", fmt="H"),
        XStrLenField(
            "encrypted_sni", "", length_from=lambda pkt: pkt.encrypted_sni_len
        ),
    ]
...
class TLS_Ext_MaxFragLen(TLS_Ext_Unknown):  # RFC 4366
    ...
    fields_desc = [
        ShortEnumField("type", 1, _tls_ext),
        ShortField("len", None),
        ByteEnumField("maxfraglen", 4, {1: "2^9", 2: "2^10", 3: "2^11", 4: "2^12"}),
    ]
...
class TAKeySHA1Hash(Packet):
    ...
    fields_desc = [
        ByteEnumField("idtype", 1, _tls_trusted_authority_types),
...
class TAX509Name(Packet):
    ...
    fields_desc = [
        ByteEnumField("idtype", 2, _tls_trusted_authority_types),
...
class TACertSHA1Hash(Packet):
    ...
    fields_desc = [
        ByteEnumField("idtype", 3, _tls_trusted_authority_types),
        StrFixedLenField("id", None, 20),
    ]
...
class TLS_Ext_TrustedCAInd(TLS_Ext_Unknown):  # RFC 4366
    ...
    fields_desc = [
        ShortEnumField("type", 3, _tls_ext),
        ShortField("len", None),
        FieldLenField("talen", None, length_of="ta"),
        _TAListField("ta", [], Raw, length_from=lambda pkt: pkt.talen),
    ]
...
class ResponderID(Packet):
    ...
    fields_desc = [
        ...
        StrLenField("respid", "", length_from=lambda pkt: pkt.respidlen),
    ]
...
class OCSPStatusRequest(Packet):
    ...
    fields_desc = [
        FieldLenField("respidlen", None, length_of="respid"),
        PacketListField(
            "respid", [], ResponderID, length_from=lambda pkt: pkt.respidlen
        ),
...
class TLS_Ext_CSR(TLS_Ext_Unknown):  # RFC 4366
    ...
    fields_desc = [
        ShortEnumField("type", 5, _tls_ext),
        ShortField("len", None),
        ByteEnumField("stype", None, _cert_status_type),
        _StatusReqField("req", [], Raw, length_from=lambda pkt: pkt.len - 1),
    ]
...
class TLS_Ext_UserMapping(TLS_Ext_Unknown):  # RFC 4681
    ...
    fields_desc = [
        ShortEnumField("type", 6, _tls_ext),
        ShortField("len", None),
        FieldLenField("umlen", None, fmt="B", length_of="um"),
        FieldListField(
            "um", [], ByteField("umtype", 0), length_from=lambda pkt: pkt.umlen
        ),
    ]
...
class TLS_Ext_ClientCertType(TLS_Ext_Unknown):  # RFC 5081
    ...
    fields_desc = [
        ...
        FieldListField(
            "ctypes",
            [0, 1],
            ByteEnumField("certtypes", None, _tls_cert_types),
...
class TLS_Ext_SupportedGroups(TLS_Ext_Unknown):
    ...
    fields_desc = [
        ...
        FieldListField(
            "groups",
            [],
            ShortEnumField("ng", None, _tls_named_groups),
...
class TLS_Ext_SupportedPointFormat(TLS_Ext_Unknown):  # RFC 4492
    ...
    fields_desc = [
        ...
        FieldListField(
            "ecpl",
            [0],
            ByteEnumField("nc", None, _tls_ecpoint_format),
...
class TLS_Ext_Heartbeat(TLS_Ext_Unknown):  # RFC 6520
    ...
    fields_desc = [
        ShortEnumField("type", 0x0F, _tls_ext),
        ShortField("len", None),
        ByteEnumField(
            "heartbeat_mode",
            2,
            {1: "peer_allowed_to_send", 2: "peer_not_allowed_to_send"},
        ),
    ]
...
class ProtocolName(Packet):
    name = "Protocol Name"
    fields_desc = [
        FieldLenField("len", None, fmt="B", length_of="protocol"),
        StrLenField("protocol", "", length_from=lambda pkt: pkt.len),
    ]
...
class TLS_Ext_ALPN(TLS_Ext_PrettyPacketList):  # RFC 7301
    ...
    fields_desc = [
        ShortEnumField("type", 0x10, _tls_ext),
        ShortField("len", None),
        FieldLenField("protocolslen", None, length_of="protocols"),
        ProtocolListField(
            "protocols", [], ProtocolName, length_from=lambda pkt: pkt.protocolslen
        ),
    ]
...
class TLS_Ext_Padding(TLS_Ext_Unknown):  # RFC 7685
    ...
    fields_desc = [
        ShortEnumField("type", 0x15, _tls_ext),
        FieldLenField("len", None, length_of="padding"),
        StrLenField("padding", "", length_from=lambda pkt: pkt.len),
    ]
...
class TLS_Ext_SessionTicket(TLS_Ext_Unknown):  # RFC 5077
    ...
    fields_desc = [
        ShortEnumField("type", 0x23, _tls_ext),
        FieldLenField("len", None, length_of="ticket"),
        StrLenField("ticket", "", length_from=lambda pkt: pkt.len),
    ]
...
_tls_ext_supported_version_cls = {
    1: TLS_Ext_SupportedVersion_CH,
...
class TLS_Ext_Cookie(TLS_Ext_Unknown):
    ...
    fields_desc = [
        ShortEnumField("type", 0x2C, _tls_ext),
        ShortField("len", None),
        FieldLenField("cookielen", None, length_of="cookie"),
        XStrLenField("cookie", "", length_from=lambda pkt: pkt.cookielen),
    ]
...
class TLS_Ext_PSKKeyExchangeModes(TLS_Ext_Unknown):
    ...
    fields_desc = [
        ...
        FieldListField(
            "kxmodes",
            [],
            ByteEnumField("kxmode", None, _tls_psk_kx_modes),
...
class TLS_Ext_TicketEarlyDataInfo(TLS_Ext_Unknown):
    name = "TLS Extension - Ticket Early Data Info"
    fields_desc = [
        ShortEnumField("type", 0x2E, _tls_ext),
        ShortField("len", None),
        IntField("max_early_data_size", 0),
    ]
...
class TLS_Ext_NPN(TLS_Ext_PrettyPacketList):
    ...
    fields_desc = [
        ShortEnumField("type", 0x3374, _tls_ext),
        FieldLenField("len", None, length_of="protocols"),
        ProtocolListField(
            "protocols", [], ProtocolName, length_from=lambda pkt: pkt.len
        ),
    ]
...
class TLS_Ext_RenegotiationInfo(TLS_Ext_Unknown):  # RFC 5746
    ...
    fields_desc = [
        ...
        ShortField("len", None),
        FieldLenField(
            "reneg_conn_len", None, fmt="B", length_of="renegotiated_connection"
        ),
        StrLenField(
            "renegotiated_connection", "", length_from=lambda pkt: pkt.reneg_conn_len
        ),
    ]
...
class TLS_Ext_RecordSizeLimit(TLS_Ext_Unknown):  # RFC 8449
    ...
    fields_desc = [
        ShortEnumField("type", 0x1C, _tls_ext),
        ShortField("len", None),
        ...
        while len(m) >= 4:
            ...
            if cls is TLS_Ext_KeyShare:
                ...
                from scapy.layers.tls.keyexchange_tls13 import (
                    _tls_ext_keyshare_cls,
                    _tls_ext_keyshare_hrr_cls,
                )
                ...
                if pkt.random_bytes and pkt.random_bytes == _tls_hello_retry_magic:
                    cls = _tls_ext_keyshare_hrr_cls.get(
                        pkt.msgtype, TLS_Ext_Unknown
                    )  # noqa: E501
                else:
                    cls = _tls_ext_keyshare_cls.get(
                        pkt.msgtype, TLS_Ext_Unknown
                    )  # noqa: E501
                ...
                cls = _tls_ext_presharedkey_cls.get(
                    pkt.msgtype, TLS_Ext_Unknown
                )  # noqa: E501
            elif cls is TLS_Ext_SupportedVersions:
                cls = _tls_ext_supported_version_cls.get(
                    pkt.msgtype, TLS_Ext_Unknown
                )  # noqa: E501
