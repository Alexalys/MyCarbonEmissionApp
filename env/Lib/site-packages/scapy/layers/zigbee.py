...
class ZigbeeNWK(Packet):
    ...
    fields_desc = [
        ...
        ConditionalField(
            ByteField("relay_count", 1), lambda pkt: pkt.flags & 0x04
        ),  # noqa: E501
        ConditionalField(
            ByteField("relay_index", 0), lambda pkt: pkt.flags & 0x04
        ),  # noqa: E501
        ConditionalField(
            FieldListField(
                "relays",
...
class ZigbeeNWKCommandPayload(Packet):
    ...
    fields_desc = [
        ...
        ConditionalField(
            BitField("res1", 0, 1), lambda pkt: pkt.cmd_identifier in [1, 2]
        ),
        ConditionalField(
            BitField("multicast", 0, 1), lambda pkt: pkt.cmd_identifier in [1, 2]
        ),
        ConditionalField(
            BitField("dest_addr_bit", 0, 1), lambda pkt: pkt.cmd_identifier == 1
        ),  # noqa: E501
        ConditionalField(
            BitEnumField(
                "many_to_one",
        ...
        ConditionalField(
            BitField("res2", 0, 3), lambda pkt: pkt.cmd_identifier == 1
        ),  # noqa: E501
        # - Route Reply Command - #
        # Command options (1 octet)
        ConditionalField(
            BitField("responder_addr_bit", 0, 1), lambda pkt: pkt.cmd_identifier == 2
        ),  # noqa: E501
        ConditionalField(
            BitField("originator_addr_bit", 0, 1), lambda pkt: pkt.cmd_identifier == 2
        ),  # noqa: E501
        ConditionalField(
            BitField("res3", 0, 4), lambda pkt: pkt.cmd_identifier == 2
        ),  # noqa: E501
        # Route request identifier (1 octet)
        ConditionalField(
            ByteField("route_request_identifier", 0),
            lambda pkt: pkt.cmd_identifier in [1, 2],
        ),  # noqa: E501
        # Originator address (2 octets)
        ConditionalField(
            XLEShortField("originator_address", 0x0000),
            lambda pkt: pkt.cmd_identifier == 2,
        ),  # noqa: E501
        # Responder address (2 octets)
        ConditionalField(
            XLEShortField("responder_address", 0x0000),
            lambda pkt: pkt.cmd_identifier == 2,
        ),  # noqa: E501
        ...
        ConditionalField(
            XLEShortField("destination_address", 0x0000),
            lambda pkt: pkt.cmd_identifier in [1, 3],
        ),
        # Path cost (1 octet)
        ConditionalField(
            ByteField("path_cost", 0), lambda pkt: pkt.cmd_identifier in [1, 2]
        ),  # noqa: E501
        ...
        ConditionalField(
            dot15d4AddressField(
                "originator_addr", 0, adjust=lambda pkt, x: 8
            ),  # noqa: E501
        ...
        ConditionalField(
            dot15d4AddressField(
                "responder_addr", 0, adjust=lambda pkt, x: 8
            ),  # noqa: E501
        ...
        ConditionalField(
            BitField("remove_children", 0, 1), lambda pkt: pkt.cmd_identifier == 4
        ),  # noqa: E501
        # Bit 6: Request
        ConditionalField(
            BitField("request", 0, 1), lambda pkt: pkt.cmd_identifier == 4
        ),  # noqa: E501
        # Bit 5: Rejoin
        ConditionalField(
            BitField("rejoin", 0, 1), lambda pkt: pkt.cmd_identifier == 4
        ),  # noqa: E501
        # Bit 0 - 4: Reserved
        ConditionalField(
            BitField("res4", 0, 5), lambda pkt: pkt.cmd_identifier == 4
        ),  # noqa: E501
        # - Route Record Command - #
        # Relay count (1 octet)
        ConditionalField(
            ByteField("rr_relay_count", 0), lambda pkt: pkt.cmd_identifier == 5
        ),  # noqa: E501
        ...
        ConditionalField(
            BitField("allocate_address", 0, 1), lambda pkt: pkt.cmd_identifier == 6
        ),  # Allocate Address  # noqa: E501
        ConditionalField(
            BitField("security_capability", 0, 1), lambda pkt: pkt.cmd_identifier == 6
        ),  # Security Capability  # noqa: E501
        ConditionalField(
            BitField("reserved2", 0, 1), lambda pkt: pkt.cmd_identifier == 6
        ),  # bit 5 is reserved  # noqa: E501
        ConditionalField(
            BitField("reserved1", 0, 1), lambda pkt: pkt.cmd_identifier == 6
        ),  # bit 4 is reserved  # noqa: E501
        ConditionalField(
            BitField("receiver_on_when_idle", 0, 1), lambda pkt: pkt.cmd_identifier == 6
        ),  # Receiver On When Idle  # noqa: E501
        ConditionalField(
            BitField("power_source", 0, 1), lambda pkt: pkt.cmd_identifier == 6
        ),  # Power Source  # noqa: E501
        ConditionalField(
            BitField("device_type", 0, 1), lambda pkt: pkt.cmd_identifier == 6
        ),  # Device Type  # noqa: E501
        ConditionalField(
            BitField("alternate_pan_coordinator", 0, 1),
            lambda pkt: pkt.cmd_identifier == 6,
        ),  # Alternate PAN Coordinator  # noqa: E501
        ...
        ConditionalField(
            ByteField("rejoin_status", 0), lambda pkt: pkt.cmd_identifier == 7
        ),  # noqa: E501
        # - Link Status Command - #
        # Command options (1 octet)
        ConditionalField(
            BitField("res5", 0, 1), lambda pkt: pkt.cmd_identifier == 8
        ),  # Reserved  # noqa: E501
        ConditionalField(
            BitField("last_frame", 0, 1), lambda pkt: pkt.cmd_identifier == 8
        ),  # Last frame  # noqa: E501
        ConditionalField(
            BitField("first_frame", 0, 1), lambda pkt: pkt.cmd_identifier == 8
        ),  # First frame  # noqa: E501
        ConditionalField(
            BitField("entry_count", 0, 5), lambda pkt: pkt.cmd_identifier == 8
        ),  # Entry count  # noqa: E501
        ...
        ConditionalField(
            BitEnumField(
                "report_command_identifier", 0, 3, {0: "PAN identifier conflict"}
            ),  # 0x01 - 0x07 Reserved  # noqa: E501
            lambda pkt: pkt.cmd_identifier == 9,
        ),
        ConditionalField(
            BitField("report_information_count", 0, 5),
            lambda pkt: pkt.cmd_identifier == 9,
        ),  # noqa: E501
        ...
        ConditionalField(
            BitEnumField(
                "update_command_identifier", 0, 3, {0: "PAN Identifier Update"}
            ),  # 0x01 - 0x07 Reserved  # noqa: E501
            lambda pkt: pkt.cmd_identifier == 10,
        ),
        ConditionalField(
            BitField("update_information_count", 0, 5),
            lambda pkt: pkt.cmd_identifier == 10,
        ),  # noqa: E501
        ...
        # Update Id (1 octet)
        ConditionalField(
            ByteField("update_id", 0), lambda pkt: pkt.cmd_identifier == 10
        ),  # noqa: E501
        # Update Information (Variable)
        # Only present if we have a PAN Identifier Update
        # New PAN ID (2 octets)
        ConditionalField(
            XLEShortField("new_PAN_ID", 0x0000),
            lambda pkt: (
        ...
        # Status (1 octet)
        ConditionalField(
            ByteEnumField("status", 0, {0: "Success", 1: "Incorrect Value"}),
...
class ZigbeeSecurityHeader(Packet):
    ...
    fields_desc = [
        ...
        ConditionalField(
            ByteField("key_seqnum", 0), lambda pkt: pkt.getfieldval("key_type") == 1
        ),  # noqa: E501
        # Payload
...
class ZigbeeAppDataPayload(Packet):
    ...
    fields_desc = [
        ...
        FlagsField(
            "frame_control", 2, 4, ["ack_format", "security", "ack_req", "extended_hdr"]
        ),
        BitEnumField(
            "delivery_mode",
            0,
            2,
            {0: "unicast", 1: "indirect", 2: "broadcast", 3: "group_addressing"},
        ),
        ...
        ConditionalField(
            ...
            lambda pkt: (
                (pkt.aps_frametype == 0 and pkt.delivery_mode in [0, 2])
                or (pkt.aps_frametype == 2 and not pkt.frame_control.ack_format)
            ),
        ),
        ...
        ConditionalField(
            ByteEnumField(
                "fragmentation", 0, {0: "none", 1: "first_block", 2: "middle_block"}
            ),
            lambda pkt: (
                pkt.aps_frametype in [0, 2] and pkt.frame_control.extended_hdr
            ),
        ),
        ConditionalField(
            ByteField("block_number", 0),
            lambda pkt: (pkt.aps_frametype in [0, 2] and pkt.fragmentation in [1, 2]),
        ),
        ConditionalField(
            ByteField("ack_bitfield", 0),
            lambda pkt: (pkt.aps_frametype == 2 and pkt.fragmentation in [1, 2]),
        ),
...
class ZigbeeAppCommandPayload(Packet):
    ...
    fields_desc = [
        ...
        ConditionalField(
            StrFixedLenField("key", None, 16), lambda pkt: pkt.cmd_identifier == 5
        ),
        ConditionalField(
            ByteField("key_seqnum", 0),
            lambda pkt: (pkt.cmd_identifier == 5 and pkt.key_type in [0x01, 0x05]),
        ),
        ConditionalField(
            dot15d4AddressField("dest_addr", 0, adjust=lambda pkt, x: 8),
            lambda pkt: (
                (pkt.cmd_identifier == 5 and pkt.key_type not in [0x02, 0x03])
                or pkt.cmd_identifier == 14
            ),
        ),
        ConditionalField(
            dot15d4AddressField("src_addr", 0, adjust=lambda pkt, x: 8),
            lambda pkt: (pkt.cmd_identifier == 5 and pkt.key_type not in [0x02, 0x03]),
        ),
        ConditionalField(
            dot15d4AddressField("partner_addr", 0, adjust=lambda pkt, x: 8),
            lambda pkt: (
                (pkt.cmd_identifier == 5 and pkt.key_type in [0x02, 0x03])
                or (pkt.cmd_identifier == 8 and pkt.key_type == 0x02)
            ),
        ),
        ConditionalField(
            ByteField("initiator_flag", 0),
            lambda pkt: (pkt.cmd_identifier == 5 and pkt.key_type in [0x02, 0x03]),
        ),
        # Update-Device Command
        ConditionalField(
            XLEShortField("short_address", 0), lambda pkt: pkt.cmd_identifier == 6
        ),
        ConditionalField(
            ByteField("update_status", 0), lambda pkt: pkt.cmd_identifier == 6
        ),
        # Switch-Key Command
        ConditionalField(
            StrFixedLenField("seqnum", None, 8), lambda pkt: pkt.cmd_identifier == 9
        ),
        # Un-implemented: 10-13 (+?)
        ConditionalField(
            StrField("unimplemented", ""),
            lambda pkt: (pkt.cmd_identifier >= 10 and pkt.cmd_identifier <= 13),
        ),
        # Tunnel Command
        ConditionalField(
            FlagsField(
        ...
        ConditionalField(
            BitEnumField("aps_frametype", 1, 2, {0: "data", 1: "command", 2: "ack"}),
            lambda pkt: pkt.cmd_identifier == 14,
        ),
        ConditionalField(ByteField("counter", 0), lambda pkt: pkt.cmd_identifier == 14),
        # Verify-Key Command
        ConditionalField(
            StrFixedLenField("key_hash", None, 16), lambda pkt: pkt.cmd_identifier == 15
        ),
    ]
...
class ZigbeeNWKStub(Packet):
    ...
    fields_desc = [
        ...
        BitField(
            "res1", 0, 2
        ),  # remaining subfields shall have a value of 0  # noqa: E501
        BitField("proto_version", 2, 4),
...
class ZigbeeAppDataPayloadStub(Packet):
    ...
    fields_desc = [
        FlagsField(
            "frame_control", 0, 4, ["reserved1", "security", "ack_req", "extended_hdr"]
        ),  # noqa: E501
        BitEnumField(
            "delivery_mode", 0, 2, {0: "unicast", 2: "broadcast", 3: "group"}
        ),  # noqa: E501
        ...
        # Cluster identifier
        EnumField(
            "cluster", 0, _zcl_cluster_identifier, fmt="<H"
        ),  # unsigned short (little-endian)  # noqa: E501
        # Profile identifier
        EnumField("profile", 0, _zcl_profile_identifier, fmt="<H"),
        # ZigBee Payload
...
class ZCLReadAttributeStatusRecord(Packet):
    ...
    fields_desc = [
        ...
        ConditionalField(
            _DiscreteString("attribute_value", ""), lambda pkt: pkt.status == 0x00
        ),
    ]
...
class ZCLGeneralReadAttributesResponse(Packet):
    ...
    fields_desc = [
        PacketListField(
            "read_attribute_status_record", [], ZCLReadAttributeStatusRecord
        ),  # noqa: E501
    ]
...
class ZCLMeteringGetProfile(Packet):
    ...
    fields_desc = [
        ...
        ByteField(
            "Interval_Channel", 0
        ),  # 0 == Consumption Delivered ; 1 == Consumption Received  # noqa: E501
        # End Time (UTCTime): 4 octets
        XLEIntField("End_Time", 0x00000000),
        # NumberOfPeriods (Unsigned 8-bit Integer): 1 octet
        ByteField(
            "NumberOfPeriods", 1
        ),  # Represents the number of intervals being requested.  # noqa: E501
    ]
...
class ZigbeeClusterLibrary(Packet):
    ...
    fields_desc = [
        ...
        BitField(
            "disable_default_response", 0, 1
        ),  # 0 default response command will be returned  # noqa: E501
        BitField(
            "command_direction", 0, 1
        ...
        BitEnumField(
            ...
            0,
            2,
            {0: "profile-wide", 1: "cluster-specific", 2: "reserved2", 3: "reserved3"},
        ),  # noqa: E501
    ...
    def guess_payload_class(self, payload):
        ...
        # Cluster-specific commands
            ...
            self.zcl_frametype == 0x01
            and self.command_identifier == 0x00
            and self.command_direction == 0
            and self.underlayer.cluster == 0x0700
        ):  # "price"  # noqa: E501
            return ZCLPriceGetCurrentPrice
        elif (
            self.zcl_frametype == 0x01
            and self.command_identifier == 0x01
            and self.command_direction == 0
            and self.underlayer.cluster == 0x0700
        ):  # "price"  # noqa: E501
