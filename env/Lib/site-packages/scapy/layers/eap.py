...
class EAP(Packet):
    ...
    fields_desc = [
        ...
        ConditionalField(
            ...
            lambda pkt: pkt.code == EAP.RESPONSE
            and hasattr(pkt, "type")
            and pkt.type == 1,
        ),  # noqa: E501
        ConditionalField(
            StrLenField("message", "", length_from=lambda pkt: pkt.len - 5),
            lambda pkt: pkt.code == EAP.REQUEST
            and hasattr(pkt, "type")
            and pkt.type == 1,
        ),  # noqa: E501
    ]
...
class EAP_MD5(EAP):
    ...
    fields_desc = [
        ...
        XStrLenField(
            ...
            if p.len is None or p.value_size is None
            else (p.len - p.value_size - 6),
        ),  # noqa: E501
    ]
...
class EAP_TLS(EAP):
    ...
    fields_desc = [
        ...
        XStrLenField(
            "tls_data",
            "",
            length_from=lambda pkt: 0 if pkt.len is None else pkt.len - (6 + 4 * pkt.L),
        ),  # noqa: E501
    ]
...
class LEAP(EAP):
    ...
    fields_desc = [
        ...
        XStrLenField(
            "challenge_response", "", length_from=lambda p: 0 or p.count
        ),  # noqa: E501
        StrLenField(
            "username", "", length_from=lambda p: p.len - (8 + (0 or p.count))
        ),  # noqa: E501
    ]
...
class MKABasicParamSet(Packet):
    ...
    fields_desc = [
        ...
        PadField(
            XStrLenField(
                "cak_name", "", length_from=lambda pkt: (pkt.param_set_body_len - 28)
            ),
            4,
            padwith=b"\x00",
        ),
...
class MKALivePeerListParamSet(MKAParamSet):
    ...
    fields_desc = [
        PadField(
            ByteEnumField("param_set_type", 1, _parameter_set_types), 2, padwith=b"\x00"
        ),
...
class MKAPotentialPeerListParamSet(MKAParamSet):
    ...
    fields_desc = [
        PadField(
            ByteEnumField("param_set_type", 2, _parameter_set_types), 2, padwith=b"\x00"
        ),
        ShortField("param_set_body_len", 0),
        PacketListField("member_id_message_num", [], MKAPeerListTuple),
    ]
...
class MKADistributedSAKParamSet(MKAParamSet):
    ...
    fields_desc = [
        ...
        XStrFixedLenField(
            "sak_aes_key_wrap", "", length=MKAParamSet.EAPOL_MKA_DEFAULT_KEY_WRAP_LEN
        ),
    ]
...
class MKADistributedCAKParamSet(MKAParamSet):
    ...
    fields_desc = [
        PadField(
            ByteEnumField("param_set_type", 5, _parameter_set_types), 2, padwith=b"\x00"
        ),
        ShortField("param_set_body_len", 0),
        XStrFixedLenField(
            "cak_aes_key_wrap", "", length=MKAParamSet.EAPOL_MKA_DEFAULT_KEY_WRAP_LEN
        ),
...
class MKAICVSet(MKAParamSet):
    ...
    fields_desc = [
        PadField(
            ByteEnumField("param_set_type", 255, _parameter_set_types),
            2,
            padwith=b"\x00",
        ),
        ShortField("param_set_body_len", 0),
