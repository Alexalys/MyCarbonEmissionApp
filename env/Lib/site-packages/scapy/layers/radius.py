...
class RadiusAttribute(Packet):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "len", None, "value", "B", adjust=lambda pkt, x: len(pkt.value) + 2
        ),
...
class _SpecificRadiusAttr(RadiusAttribute):
    ...
    def __init__(
        self, _pkt="", post_transform=None, _internal=0, _underlayer=None, **fields
    ):  # noqa: E501
        super(_SpecificRadiusAttr, self).__init__(
            _pkt, post_transform, _internal, _underlayer, **fields
        )
...
class _RadiusAttrHexStringVal(_SpecificRadiusAttr):
    ...
    fields_desc = [
        ...
        XStrLenField(
            "value", "", length_from=lambda p: p.len - 2 if p.len else 0
        ),  # noqa: E501
    ]
...
class RadiusAttr_Message_Authenticator(_RadiusAttrHexStringVal):
    ...
    def compute_message_authenticator(
        radius_packet, packed_req_authenticator, shared_secret
    ):
        """
...
class _RadiusAttrIntEnumVal(_SpecificRadiusAttr):
    ...
    fields_desc = [
        ...
        ByteField("len", 6),
        MultiEnumField(
            "value", 0, _radius_attrs_values, depends_on=lambda p: p.type, fmt="I"
        ),
    ]
...
class RadiusAttr_Vendor_Specific(RadiusAttribute):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "len", None, "value", "B", adjust=lambda pkt, x: len(pkt.value) + 8
        ),
        IntField("vendor_id", 0),
        ByteField("vendor_type", 0),
        FieldLenField(
            "vendor_len", None, "value", "B", adjust=lambda p, x: len(p.value) + 2
        ),
...
class Radius(Packet):
    ...
    fields_desc = [
        ...
        PacketListField(
            "attributes", [], RadiusAttribute, length_from=lambda pkt: pkt.len - 20
        ),
    ]
