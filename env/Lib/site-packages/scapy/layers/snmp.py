...
class SNMPvarbind(ASN1_Packet):
    ...
    ASN1_root = ASN1F_SEQUENCE(
        ASN1F_OID("oid", "1.3"), ASN1F_field("value", ASN1_NULL(0))
    )
...
class SNMP(ASN1_Packet):
    ...
    def answers(self, other):
        return (
            isinstance(self.PDU, SNMPresponse)
            and isinstance(other.PDU, (SNMPget, SNMPnext, SNMPset))
            and self.PDU.id == other.PDU.id
        )
