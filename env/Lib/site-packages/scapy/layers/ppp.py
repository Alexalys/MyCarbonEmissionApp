...
class PPP_IPCP_Option(Packet):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "len", None, length_of="data", fmt="B", adjust=lambda _, val: val + 2
        ),
...
class PPP_IPCP(Packet):
    fields_desc = [
        ...
        XByteField("id", 0),
        FieldLenField(
            "len", None, fmt="H", length_of="options", adjust=lambda _, val: val + 4
        ),
        PacketListField(
            "options", [], PPP_IPCP_Option, length_from=lambda pkt: pkt.len - 4
        ),
    ]
...
class PPP_ECP_Option_OUI(PPP_ECP_Option):
    fields_desc = [
        ...
        FieldLenField(
            "len", None, length_of="data", fmt="B", adjust=lambda _, val: val + 6
        ),
        OUIField("oui", 0),
        ByteField("subtype", 0),
...
class PPP_ECP(Packet):
    fields_desc = [
        ...
        PacketListField(
            "options", [], PPP_ECP_Option, length_from=lambda pkt: pkt.len - 4
        ),
    ]
...
class PPP_LCP(Packet):
    ...
    fields_desc = [
        ...
        XByteField("id", 0),
        FieldLenField(
            "len", None, fmt="H", length_of="data", adjust=lambda _, val: val + 4
        ),
...
class PPP_LCP_Option(Packet):
    ...
    fields_desc = [
        ...
        FieldLenField(
            "len", None, fmt="B", length_of="data", adjust=lambda _, val: val + 2
        ),
...
class PPP_LCP_MRU_Option(PPP_LCP_Option):
    fields_desc = [
        ByteEnumField("type", 1, _PPP_lcp_optiontypes),
        ByteField("len", 4),
...
class PPP_LCP_Quality_Protocol_Option(PPP_LCP_Option):
    fields_desc = [
        ...
        FieldLenField(
            "len", None, fmt="B", length_of="data", adjust=lambda _, val: val + 4
        ),
...
class PPP_LCP_Callback_Option(PPP_LCP_Option):
    fields_desc = [
        ...
        FieldLenField(
            "len", None, fmt="B", length_of="message", adjust=lambda _, val: val + 3
        ),
...
class PPP_LCP_Configure(PPP_LCP):
    fields_desc = [
        ...
        PacketListField(
            "options", [], PPP_LCP_Option, length_from=lambda pkt: pkt.len - 4
        ),
    ]

    def answers(self, other):
        return (
            isinstance(other, PPP_LCP_Configure)
...
class PPP_LCP_Terminate(PPP_LCP):
    def answers(self, other):
        return (
            isinstance(other, PPP_LCP_Terminate)
            and self.code == 6
            and other.code == 5
            and other.id == self.id
        )
...
class PPP_LCP_Discard_Request(PPP_LCP):
    fields_desc = [
        ...
        XByteField("id", 0),
        FieldLenField(
            "len", None, fmt="H", length_of="data", adjust=lambda _, val: val + 8
        ),
        IntField("magic_number", None),
...
class PPP_PAP_Request(PPP_PAP):
    ...
    def mysummary(self):
        return self.sprintf(
            "PAP-Request username=%PPP_PAP_Request.username%"
...
class PPP_PAP_Response(PPP_PAP):
    fields_desc = [
        ...
        XByteField("id", 0),
        FieldLenField(
            "len", None, fmt="!H", length_of="message", adjust=lambda _, val: val + 5
        ),
...
class PPP_CHAP(Packet):
    ...
    def answers(self, other):
        return (
            isinstance(other, PPP_CHAP_ChallengeResponse)
            and other.code == 2
            and self.code in (3, 4)
            and self.id == other.id
        )
...
class PPP_CHAP_ChallengeResponse(PPP_CHAP):
    fields_desc = [
        ...
        StrLenField(
            "optional_name", "", length_from=lambda pkt: pkt.len - pkt.value_size - 5
        ),
    ]
